...
public class M100_CautionMstRt{
	/*
	コピペ用
	...
	*/
	...
	public static Object[][] CautionMstRt(
		...
		String sql = " select \n"
				...
				+ " from "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0090_CAUTION\n"
				+ " left outer join "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0031_CLIENT_GROUP"
				+ " on("
				+ " "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0090_CAUTION.ClGpCD = "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0031_CLIENT_GROUP.ClGpCD"
				+ " )"
				+ " left outer join "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0040_DELIVERYMST"
				+ " on("
				+ " "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0090_CAUTION.DECD = "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0040_DELIVERYMST.DECD"
				+ " )"
				+ " where 1=1\n";
	...
	public static String[] NewCautionCdGet(int NeedCount) {
    	...
    	for(int i=0;i<CautionMstRt.length;i++) {
    		if(4<(""+CautionMstRt[i][M100_CautionMstRt.ColCautionCd]).length()&&"ATCT".equals((""+CautionMstRt[i][M100_CautionMstRt.ColCautionCd]).substring(0,4))) {
    			String WST = B100_TextControl.num_only_String(""+CautionMstRt[i][M100_CautionMstRt.ColCautionCd]);
    			if(9==WST.length()) {
