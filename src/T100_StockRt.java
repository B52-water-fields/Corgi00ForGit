...
public class T100_StockRt{
	...
	*/
	...
	public static Object[][] StockRt(
		...
		SearchQtyMax			= B100_ArrayListControl.ArryListIntegerUniqueList(SearchQtyMax);			//数量最大
		SearchShipPlanQtyMin	= B100_ArrayListControl.ArryListIntegerUniqueList(SearchShipPlanQtyMin);	//引当済数最小
		SearchShipPlanQtyMax	= B100_ArrayListControl.ArryListIntegerUniqueList(SearchShipPlanQtyMax);	//引当済数最大
		SearchPossibleQtyMin	= B100_ArrayListControl.ArryListIntegerUniqueList(SearchPossibleQtyMin);	//出荷可能数最小
		SearchPossibleQtyMax	= B100_ArrayListControl.ArryListIntegerUniqueList(SearchPossibleQtyMax);	//出荷可能数最大
		...
		SearchJanCd				= B100_ArrayListControl.ArryListStringUniqueList(SearchJanCd);				//ソースマーク_BCD（バラ）
