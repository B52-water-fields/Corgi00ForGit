...
public class A100_DbConnect {
	//データベースに接続する
	// ================================================================================================================================
    //  A100_DbConnect（スフィンクス／旅人への試練）
    // ================================================================================================================================
    //
    //このクラスは、A00000_Mainでiniファイル読み込んだ又は、直書きされた
	...
	public static void DB_CONN(String TgtDB){
		//データベース接続設定引継ぎ
		String SshHostName = A00000_Main.DefaultSshHostName;
		int SshHostPort = A00000_Main.DefaultSshHostPort;
		String SshUserName = A00000_Main.DefaultSshUserName;
		String SshKeyFld = A00000_Main.DefaultSshKeyFld;
		String SshKeyFileName = A00000_Main.DefaultSshKeyFileName;
		String SshKeyFile = A00000_Main.DefaultSshKeyFld + "\\" + A00000_Main.DefaultSshKeyFileName;
		String SshPass = A00000_Main.DefaultSshPass;
		String MySqlHostName = A00000_Main.DefaultMySqlHostName;
		int MySqlSverPort = A00000_Main.DefaultMySqlSverPort;
		String MySqlUser = A00000_Main.DefaultMySqlUser;
		String MySqlPass = A00000_Main.DefaultMySqlPass;
