...
public class WM100_ParameterMstWanko_02_ExcelEntry{
	static int SetX;
	static int SetY;
	...
	public static void ParameterMstWankoExcelEntry(int x,int y,String TgtFilePath) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,600,200,"Corgi00荷主パラメータ登録（エクセル）　WM100_ParameterMstWanko_02_ExcelEntry","");
	...
	public static void ParameterMstWankoExcelEntryMain(int x,int y,String TgtFilePath,String SheetName){
		...
		if(y==0) {y=SetY;}
		RenewFg = false;
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,750,800,"Corgi00荷主パラメータ登録（エクセル）　WM100_ParameterMstWanko_02_ExcelEntry","");
		JLabel userinfo = B100_FrameParts.UserInfo();
		JButton exit_btn = B100_FrameParts.ExitBtn();
		JButton entry_btn = B100_FrameParts.EntryBtn();
		...
		String[] Title = B100_RtObjectCreate.RtTitleName(M100_ParameterMstWankoRt.RtParameterMstWankoRt());
		
		Object[][] NeedCol = {
				 {Title[M100_ParameterMstWankoRt.ColClWh]			,1	, 0}
				,{Title[M100_ParameterMstWankoRt.ColClCd]			,1	, 1}
				,{Title[M100_ParameterMstWankoRt.ColParaCd]		,1	, 2}
				,{Title[M100_ParameterMstWankoRt.ColParaCdSeq]	,0	, 3}
				,{Title[M100_ParameterMstWankoRt.ColParaName]		,1	, 4}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt01]	,1	, 5}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt02]	,1	, 6}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt03]	,1	, 7}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt04]	,1	, 8}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt05]	,1	, 9}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt06]	,1	,10}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt07]	,1	,11}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt08]	,1	,12}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt09]	,1	,13}
				,{Title[M100_ParameterMstWankoRt.ColParaTxt10]	,1	,14}
				,{Title[M100_ParameterMstWankoRt.ColParaInt01]	,0	,15}
				,{Title[M100_ParameterMstWankoRt.ColParaInt02]	,0	,16}
				,{Title[M100_ParameterMstWankoRt.ColParaInt03]	,0	,17}
				,{Title[M100_ParameterMstWankoRt.ColParaInt04]	,0	,18}
				,{Title[M100_ParameterMstWankoRt.ColParaInt05]	,0	,19}
				,{Title[M100_ParameterMstWankoRt.ColParaInt06]	,0	,20}
				,{Title[M100_ParameterMstWankoRt.ColParaInt07]	,0	,21}
				,{Title[M100_ParameterMstWankoRt.ColParaInt08]	,0	,22}
				,{Title[M100_ParameterMstWankoRt.ColParaInt09]	,0	,23}
				,{Title[M100_ParameterMstWankoRt.ColParaInt10]	,0	,24}
	...
	private static void MstEntry(Object[][] CheckOb,String[] TableCol) {
		...
		for(int i=0;i<TableCol.length;i++) {
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColClWh]			)){ColClWh		= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColClCd]			)){ColClCd		= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaCd]		)){ColParaCd	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaCdSeq]	)){ColParaCdSeq	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaName]		)){ColParaName	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt01]	)){ColParaTxt01	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt02]	)){ColParaTxt02	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt03]	)){ColParaTxt03	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt04]	)){ColParaTxt04	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt05]	)){ColParaTxt05	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt06]	)){ColParaTxt06	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt07]	)){ColParaTxt07	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt08]	)){ColParaTxt08	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt09]	)){ColParaTxt09	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaTxt10]	)){ColParaTxt10	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt01]	)){ColParaInt01	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt02]	)){ColParaInt02	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt03]	)){ColParaInt03	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt04]	)){ColParaInt04	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt05]	)){ColParaInt05	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt06]	)){ColParaInt06	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt07]	)){ColParaInt07	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt08]	)){ColParaInt08	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt09]	)){ColParaInt09	= i;}
			if(TableCol[i].equals(Title[M100_ParameterMstWankoRt.ColParaInt10]	)){ColParaInt10	= i;}
		}
		int EntryCount = 0;
		for(int i=0;i<CheckOb.length;i++) {
			...
			CheckClWh		= B100_TextControl.Trim(CheckClWh);			//担当倉庫コード
			CheckClCd		= B100_TextControl.Trim(CheckClCd);			//荷主コード
		...
		for(int i=0;i<CheckOb.length;i++) {
			...
			if("".equals(CheckClWh)
				...
				GetClWh[EntryCount]			= B100_TextControl.Trim(GetClWh[EntryCount]);			//担当倉庫コード
				GetClCd[EntryCount]			= B100_TextControl.Trim(GetClCd[EntryCount]);			//荷主コード
	...
	private static ArrayList<String> ErrCheck(Object[][] CheckOb,String[] TableCol){
		...
		for(int i=0;i<CheckOb.length;i++) {
			...
			GetClWh			= B100_TextControl.Trim(GetClWh);			//担当倉庫コード
			...
			if("".equals(GetClWh)
				...
				if(!A00000_Main.ClWh.equals(GetClWh)) {
					int wint = i+1;
	...
	private static void ErrView(ArrayList<String>ErrMsg) {
		...
		FLD_PATH = A00000_Main.MainFLD+"\\MstControl\\ParameterMstWanko";
		B100_FolderCheck.FLD_CHECK(FLD_PATH);
		FLD_PATH = A00000_Main.MainFLD+"\\MstControl\\ParameterMstWanko\\Err";
		B100_FolderCheck.FLD_CHECK(FLD_PATH);
		FLD_PATH = A00000_Main.MainFLD+"\\MstControl\\ParameterMstWanko\\BK";
		B100_FolderCheck.FLD_CHECK(FLD_PATH);
