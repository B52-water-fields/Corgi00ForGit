...
public class WM100DeliveryTypeMstRenewAndCreate{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(GetSearchDeliveryTypeNo)&&!"".equals(GetDeliveryTypeCd)&&!"".equals(GetDeliveryTypeName)) {
						...
						WM100DeliveryTypeMstRenewAndCreate.DeliveryTypeMstRenewAndCreate(0,0,GetSearchDeliveryTypeNo,GetDeliveryTypeCd);
