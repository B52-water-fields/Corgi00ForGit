...
public class M100_DeliveryTypeMstRt{
	/*
	コピペ用
	...
	String GetUpdateUser		= (String)DeliveryTypeMstRt[i][M100_DeliveryTypeMstRt.ColUpdateUser];			//更新者コード
	*/
	...
	public static Object[][] DeliveryTypeMstRt(
		...
		SearchDeliveryTypeNo	= B100_ArrayListControl.ArryListStringUniqueList(SearchDeliveryTypeNo);
		...
		+" from "+A00000_Main.MySqlDefaultSchemaNYANKO+".KM0050_DELIVERY_TYPEMST"
		+" where 1=1";
