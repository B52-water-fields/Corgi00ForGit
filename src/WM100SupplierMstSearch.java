...
public class WM100SupplierMstSearch{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(KickFg) {
						...
						main_fm.dispose();
						WM100SupplierMstRenewAndCreate.SupplierMstRenewAndCreate(0,0,TgtClCd,TgtWhCd,TgtSupplierCd);
					}
					RenewFg = true;
				}
			}
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100SupplierMstExcelEntry.SupplierMstExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
