...
public class WM100ShippingCompanyMstSearch{
	static int SetX;
	static int SetY;
	...
	public static void ShippingCompanyMstSearch(int x,int y) {
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtShippingCompanyCd)) {
						...
						main_fm.dispose();
						WM100ShippingCompanyMstRenewAndCreate.ShippingCompanyMstRenewAndCreate(0,0,TgtShippingCompanyCd);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				...
				main_fm.setVisible(false);
				main_fm.dispose();
				WM100ShippingCompanyMstRenewAndCreate.ShippingCompanyMstRenewAndCreate(0,0,"");
			}
		});
