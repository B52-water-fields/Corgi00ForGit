...
public class WM100_ParameterMstNyanko_00_Seach{
	...
	public static void ParameterMstNyankoSeach(int x,int y) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,1200,750,"Corgi00共通パラメータマスタ（NYANKO）検索","");
				...
				if(RenewFg) {
					...
					for(int i=0;i<RowCount;i++) {
						if((boolean)tableModel_ms01.getValueAt(i, 0)) {
							TgtParaCd 		= ""+tableModel_ms01.getValueAt(i, M100_ParameterMstRt.ColParaCd+1);
							TgtParaCdSeq	= ""+tableModel_ms01.getValueAt(i, M100_ParameterMstRt.ColParaCdSeq+1);
						}
					}
