...
public class WM100_ParameterMstNyanko_00_Seach{
	static int SetX;
	static int SetY;
	static boolean RenewFg;
	public static void ParameterMstNyankoSeach(int x,int y) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,1200,750,"Corgi00共通パラメータマスタ（NYANKO）検索　WM100_ParameterMstNyanko_00_Seach","");
		...
		//検索条件パネル
		JPanel PN_Search = B100_FrameParts.JPanelSet(10,40,1180,300,"White");
		JLabel PN_SearchLabel = B100_FrameParts.JLabelSet(10,0,150,20,"検索条件",11,0);
		PN_Search.add(PN_SearchLabel);
		
		Object[][] DefinitionRt	= M100_ParameterMstRtNyanko.DefinitionRt();
		/*****************/
		
		JLabel LB_SearchParaCd			= B100_FrameParts.JLabelSet(	  0, 25,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaCd][5]			+":"	,11,1);
		JLabel LB_SearchParaCdSeq		= B100_FrameParts.JLabelSet(	  0, 50,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaCdSeqStr][5]	+":"	,11,1);
		JLabel LB_SearchParaName		= B100_FrameParts.JLabelSet(	  0, 75,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaName][5]		+":"	,11,1);
		JLabel LB_SearchParaTxtAll		= B100_FrameParts.JLabelSet(	  0,100,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxtAll][5]	+":"	,10,1);
		
		JLabel LB_SearchParaTxt01		= B100_FrameParts.JLabelSet(	310, 25,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt01][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt02		= B100_FrameParts.JLabelSet(	310, 50,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt02][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt03		= B100_FrameParts.JLabelSet(	310, 75,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt03][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt04		= B100_FrameParts.JLabelSet(	310,100,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt04][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt05		= B100_FrameParts.JLabelSet(	310,125,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt05][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt06		= B100_FrameParts.JLabelSet(	310,150,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt06][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt07		= B100_FrameParts.JLabelSet(	310,175,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt07][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt08		= B100_FrameParts.JLabelSet(	310,200,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt08][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt09		= B100_FrameParts.JLabelSet(	310,225,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt09][5]		+":"	,11,1);
		JLabel LB_SearchParaTxt10		= B100_FrameParts.JLabelSet(	310,250,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaTxt10][5]		+":"	,11,1);
		
		JLabel LB_SearchParaInt01		= B100_FrameParts.JLabelSet(	620, 25,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt01Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt02		= B100_FrameParts.JLabelSet(	620, 50,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt02Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt03		= B100_FrameParts.JLabelSet(	620, 75,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt03Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt04		= B100_FrameParts.JLabelSet(	620,100,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt04Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt05		= B100_FrameParts.JLabelSet(	620,125,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt05Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt06		= B100_FrameParts.JLabelSet(	620,150,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt06Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt07		= B100_FrameParts.JLabelSet(	620,175,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt07Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt08		= B100_FrameParts.JLabelSet(	620,200,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt08Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt09		= B100_FrameParts.JLabelSet(	620,225,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt09Str][5]	+":"	,11,1);
		JLabel LB_SearchParaInt10		= B100_FrameParts.JLabelSet(	620,250,130,20,(String)DefinitionRt[M100_ParameterMstRtNyanko.ColSearchParaInt10Str][5]	+":"	,11,1);
		/*****************/
		...
		/*****************/
		JLabel LB2_SearchParaCd			= B100_FrameParts.JLabelSet(	230, 25, 80,20,B100_DefaultVariable.SearchExact		,11,0);
		JLabel LB2_SearchParaCdSeq	= B100_FrameParts.JLabelSet(		210, 50, 20,20,B100_DefaultVariable.SearchFromTo		,11,2);
		JLabel LB2_SearchParaName		= B100_FrameParts.JLabelSet(	230, 75, 80,20,B100_DefaultVariable.SearchPartial		,11,0);
		JLabel LB2_SearchParaTxtAll		= B100_FrameParts.JLabelSet(	230,100, 80,20,B100_DefaultVariable.SearchPartial		,11,0);
		...
		//検索ボタン
		JButton SearchBtn = B100_FrameParts.BtnSet(130,150,100,20,"検索",11);
		PN_Search.add(SearchBtn);
		
		//条件クリアボタン
		JButton ClearBtn = B100_FrameParts.BtnSet( 10,150,100,20,"条件クリア",11);
		...
		//スクロール用設定
		JScrollPane scpn01 = B100_FrameParts.JScrollPaneSet(10,350,1180,280,tb01);
		main_fm.add(scpn01);
		...
		SearchBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					GetSearchParaCd			= B100_TextControl.Trim(GetSearchParaCd);
					GetSearchParaCdSeqStr	= B100_TextControl.Trim(GetSearchParaCdSeqStr);
					GetSearchParaCdSeqEnd	= B100_TextControl.Trim(GetSearchParaCdSeqEnd);
					GetSearchParaName		= B100_TextControl.Trim(GetSearchParaName);
					GetSearchParaTxt01		= B100_TextControl.Trim(GetSearchParaTxt01);
					GetSearchParaTxt02		= B100_TextControl.Trim(GetSearchParaTxt02);
					GetSearchParaTxt03		= B100_TextControl.Trim(GetSearchParaTxt03);
					GetSearchParaTxt04		= B100_TextControl.Trim(GetSearchParaTxt04);
					GetSearchParaTxt05		= B100_TextControl.Trim(GetSearchParaTxt05);
					GetSearchParaTxt06		= B100_TextControl.Trim(GetSearchParaTxt06);
					GetSearchParaTxt07		= B100_TextControl.Trim(GetSearchParaTxt07);
					GetSearchParaTxt08		= B100_TextControl.Trim(GetSearchParaTxt08);
					GetSearchParaTxt09		= B100_TextControl.Trim(GetSearchParaTxt09);
					GetSearchParaTxt10		= B100_TextControl.Trim(GetSearchParaTxt10);
					GetSearchParaInt01Str	= B100_TextControl.Trim(GetSearchParaInt01Str);
					GetSearchParaInt02Str	= B100_TextControl.Trim(GetSearchParaInt02Str);
					GetSearchParaInt03Str	= B100_TextControl.Trim(GetSearchParaInt03Str);
					GetSearchParaInt04Str	= B100_TextControl.Trim(GetSearchParaInt04Str);
					GetSearchParaInt05Str	= B100_TextControl.Trim(GetSearchParaInt05Str);
					GetSearchParaInt06Str	= B100_TextControl.Trim(GetSearchParaInt06Str);
					GetSearchParaInt07Str	= B100_TextControl.Trim(GetSearchParaInt07Str);
					GetSearchParaInt08Str	= B100_TextControl.Trim(GetSearchParaInt08Str);
					GetSearchParaInt09Str	= B100_TextControl.Trim(GetSearchParaInt09Str);
					GetSearchParaInt10Str	= B100_TextControl.Trim(GetSearchParaInt10Str);
					GetSearchParaInt01End	= B100_TextControl.Trim(GetSearchParaInt01End);
					GetSearchParaInt02End	= B100_TextControl.Trim(GetSearchParaInt02End);
					GetSearchParaInt03End	= B100_TextControl.Trim(GetSearchParaInt03End);
					GetSearchParaInt04End	= B100_TextControl.Trim(GetSearchParaInt04End);
					GetSearchParaInt05End	= B100_TextControl.Trim(GetSearchParaInt05End);
					GetSearchParaInt06End	= B100_TextControl.Trim(GetSearchParaInt06End);
					GetSearchParaInt07End	= B100_TextControl.Trim(GetSearchParaInt07End);
					GetSearchParaInt08End	= B100_TextControl.Trim(GetSearchParaInt08End);
					GetSearchParaInt09End	= B100_TextControl.Trim(GetSearchParaInt09End);
					GetSearchParaInt10End	= B100_TextControl.Trim(GetSearchParaInt10End);
					GetSearchParaTxtAll		= B100_TextControl.Trim(GetSearchParaTxtAll);
					
					GetSearchParaCdSeqStr	= B100_TextControl.num_only_String02(GetSearchParaCdSeqStr);
					GetSearchParaCdSeqEnd	= B100_TextControl.num_only_String02(GetSearchParaCdSeqEnd);
					GetSearchParaInt01Str	= B100_TextControl.num_only_String02(GetSearchParaInt01Str);
					GetSearchParaInt02Str	= B100_TextControl.num_only_String02(GetSearchParaInt02Str);
					GetSearchParaInt03Str	= B100_TextControl.num_only_String02(GetSearchParaInt03Str);
					GetSearchParaInt04Str	= B100_TextControl.num_only_String02(GetSearchParaInt04Str);
					GetSearchParaInt05Str	= B100_TextControl.num_only_String02(GetSearchParaInt05Str);
					GetSearchParaInt06Str	= B100_TextControl.num_only_String02(GetSearchParaInt06Str);
					GetSearchParaInt07Str	= B100_TextControl.num_only_String02(GetSearchParaInt07Str);
					GetSearchParaInt08Str	= B100_TextControl.num_only_String02(GetSearchParaInt08Str);
					GetSearchParaInt09Str	= B100_TextControl.num_only_String02(GetSearchParaInt09Str);
					GetSearchParaInt10Str	= B100_TextControl.num_only_String02(GetSearchParaInt10Str);
					GetSearchParaInt01End	= B100_TextControl.num_only_String02(GetSearchParaInt01End);
					GetSearchParaInt02End	= B100_TextControl.num_only_String02(GetSearchParaInt02End);
					GetSearchParaInt03End	= B100_TextControl.num_only_String02(GetSearchParaInt03End);
					GetSearchParaInt04End	= B100_TextControl.num_only_String02(GetSearchParaInt04End);
					GetSearchParaInt05End	= B100_TextControl.num_only_String02(GetSearchParaInt05End);
					GetSearchParaInt06End	= B100_TextControl.num_only_String02(GetSearchParaInt06End);
					GetSearchParaInt07End	= B100_TextControl.num_only_String02(GetSearchParaInt07End);
					GetSearchParaInt08End	= B100_TextControl.num_only_String02(GetSearchParaInt08End);
					GetSearchParaInt09End	= B100_TextControl.num_only_String02(GetSearchParaInt09End);
					GetSearchParaInt10End	= B100_TextControl.num_only_String02(GetSearchParaInt10End);
					...
					for(int i=0;i<ParameterMstRtNANKO.length;i++) {
						Object[] SetOb = new Object[ParameterMstRtNANKO[i].length+1];
						SetOb[0] = false;
						for(int i01=0;i01<ParameterMstRtNANKO[i].length;i01++) {
							SetOb[i01+1] = ""+ParameterMstRtNANKO[i][i01];
						}
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtParaCd) && !"".equals(TgtParaCdSeq)) {
						...
						WM100_ParameterMstNyanko_01_RenewAndCreate.ParameterMstNyankoRenewAndCreate(0,0,TgtParaCd,TgtParaCdSeq);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WM100_ParameterMstNyanko_01_RenewAndCreate.ParameterMstNyankoRenewAndCreate(0,0,"","");
					RenewFg = true;
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100_ParameterMstNyanko_02_ExcelEntry.ParameterMstNyankoExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
		...
		CsvBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					RenewFg = false;
					B100_TableControl.TableOutPutCsv("出力先選択","共通パラメータマスタ検索結果",tb01);
					RenewFg = true;
				}
			}
		});
		...
		ExcelBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					RenewFg = false;
					B100_TableControl.TableOutPutExcel("出力先選択","共通パラメータマスタ検索結果",tb01);
					RenewFg = true;
				}
			}
		});
