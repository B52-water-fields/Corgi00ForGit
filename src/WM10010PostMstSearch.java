...
public class WM10010PostMstSearch{
	...
	public static void PostMstSearch(int x,int y) {
		...
		tb01.setFont(new Font("ＭＳ ゴシック", Font.PLAIN, 12*A00000Main.Mul/A00000Main.Div));
		
		DefaultTableColumnModel columnModel01
		= (DefaultTableColumnModel)tb01.getColumnModel();

		//表示位置設定用
		DefaultTableCellRenderer rightCellRenderer =
				  new DefaultTableCellRenderer();
				rightCellRenderer.setHorizontalAlignment(JLabel.RIGHT);
		DefaultTableCellRenderer leftCellRenderer =
				  new DefaultTableCellRenderer();
				leftCellRenderer.setHorizontalAlignment(JLabel.LEFT);
		DefaultTableCellRenderer centerCellRenderer =
				  new DefaultTableCellRenderer();
		...
		column = columnModel01.getColumn( 1);	column.setPreferredWidth( 80*A00000Main.Mul/A00000Main.Div);	column.setCellRenderer(leftCellRenderer);	//郵便番号
		column = columnModel01.getColumn( 2);	column.setPreferredWidth(100*A00000Main.Mul/A00000Main.Div);	column.setCellRenderer(leftCellRenderer);	//県
		column = columnModel01.getColumn( 3);	column.setPreferredWidth(200*A00000Main.Mul/A00000Main.Div);	column.setCellRenderer(leftCellRenderer);	//市区町村
		column = columnModel01.getColumn( 4);	column.setPreferredWidth(200*A00000Main.Mul/A00000Main.Div);	column.setCellRenderer(leftCellRenderer);	//町丁目
		column = columnModel01.getColumn( 5);	column.setPreferredWidth(120*A00000Main.Mul/A00000Main.Div);	column.setCellRenderer(leftCellRenderer);	//市区町村CD
		
		//スクロール用設定
		JScrollPane scpn01 = new JScrollPane(tb01);
		...
		scpn01.setBounds(10*A00000Main.Mul/A00000Main.Div,160*A00000Main.Mul/A00000Main.Div,740*A00000Main.Mul/A00000Main.Div,500*A00000Main.Mul/A00000Main.Div);
		main_fm.add(scpn01);
		...
		//CSVボタン
		JButton CsvBtn = B00110FrameParts.BtnSet(10,670,100,20,"csv出力",11);
		main_fm.add(CsvBtn);
