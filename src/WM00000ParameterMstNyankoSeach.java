...
public class WM00000ParameterMstNyankoSeach{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtParaCd) && !"".equals(TgtParaCdSeq)) {
						...
						WM00001ParameterMstNyankoRenewAndCreate.ParameterMstNyankoRenewAndCreate(0,0,TgtParaCd,TgtParaCdSeq);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WM00001ParameterMstNyankoRenewAndCreate.ParameterMstNyankoRenewAndCreate(0,0,"","");
					RenewFg = true;
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM00002ParameterMstNyankoExcelEntry.ParameterMstNyankoExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
