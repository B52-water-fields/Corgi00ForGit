...
public class WT0001005ArrivalPlanArrayEntrySetDataView{
	/******************************************************************
		WT0001004ArrivalPlanArrayEntrySourceDataView で
	...
	******************************************************************/
	...
	public static void ArrivalPlanArrayEntrySetDataView(int x,int y,Object[][] EntryData) {
		...
		final JFrame main_fm = B00110FrameParts.FrameCreate(x,y,900,750,"Corgi00入荷予定取込（登録データ確認）","");
