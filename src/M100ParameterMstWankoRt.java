...
public class M100ParameterMstWankoRt{
	...
	*/
	...
	public static Object[][] ParameterMstWankoRt(
		...
		SearchClWh		= B100ArrayListControl.ArryListStringUniqueList(SearchClWh);
		...
		if(true==SearchKick) {
			...
			try {
				...
				while (rset01.next()) {
					...
					if(null==rset01.getTimestamp("UpdateDate"	)){rt[counter][ColEntryDate]	="";}else{rt[counter][ColUpdateDate]	=B100DateTimeControl.dtmString2(rset01.getTimestamp("UpdateDate"))[1];}		//更新日
