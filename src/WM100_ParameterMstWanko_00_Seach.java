...
public class WM100_ParameterMstWanko_00_Seach{
	static int SetX;
	static int SetY;
	...
	public static void ParameterMstWankoSeach(int x,int y) {
		...
		JLabel LB2_SearchParaCd			= B100_FrameParts.JLabelSet(	  							230, 75, 80,20,"と一致"						,11,0);
		...
		JLabel LB2_SearchParaCdSeq	= B100_FrameParts.JLabelSet(									210,100, 20,20,"～"							,11,2);
		...
		JLabel LB2_SearchParaName		= B100_FrameParts.JLabelSet(								230,125, 80,20,"を含む"						,11,0);
		...
		JLabel LB2_SearchParaTxtAll		= B100_FrameParts.JLabelSet(								230,150, 80,20,"を含む"						,11,0);
		...
		JLabel LB2_SearchParaTxt01		= B100_FrameParts.JLabelSet(					540, 25, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt02		= B100_FrameParts.JLabelSet(					540, 50, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt03		= B100_FrameParts.JLabelSet(					540, 75, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt04		= B100_FrameParts.JLabelSet(					540,100, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt05		= B100_FrameParts.JLabelSet(					540,125, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt06		= B100_FrameParts.JLabelSet(					540,150, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt07		= B100_FrameParts.JLabelSet(					540,175, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt08		= B100_FrameParts.JLabelSet(					540,200, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt09		= B100_FrameParts.JLabelSet(					540,225, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaTxt10		= B100_FrameParts.JLabelSet(					540,250, 80,20,"を含む"				,11,0);
		...
		JLabel LB2_SearchParaInt01	= B100_FrameParts.JLabelSet(										850, 25, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt02	= B100_FrameParts.JLabelSet(										850, 50, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt03	= B100_FrameParts.JLabelSet(										850, 75, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt04	= B100_FrameParts.JLabelSet(										850,100, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt05	= B100_FrameParts.JLabelSet(										850,125, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt06	= B100_FrameParts.JLabelSet(										850,150, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt07	= B100_FrameParts.JLabelSet(										850,175, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt08	= B100_FrameParts.JLabelSet(										850,200, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt09	= B100_FrameParts.JLabelSet(										850,225, 20,20,"～"					,11,2);
		...
		JLabel LB2_SearchParaInt10	= B100_FrameParts.JLabelSet(										850,250, 20,20,"～"					,11,2);
		...
		//条件クリアボタン
		JButton ClearBtn = B100_FrameParts.BtnSet( 10,200,100,20,"条件クリア",11);
		...
		for(int i=0;i<RtParameterMstWankoRt.length;i++) {
			columnNames01[1+(int)RtParameterMstWankoRt[i][1]] = ""+RtParameterMstWankoRt[i][3];
		}
		...
		for(int i=0;i<RtParameterMstWankoRt.length;i++) {
			if("int".equals((String)RtParameterMstWankoRt[i][2])||"float".equals((String)RtParameterMstWankoRt[i][2])){
				column = columnModel01.getColumn(1+(int)RtParameterMstWankoRt[i][1]);	column.setPreferredWidth( 90*A00000_Main.Mul/A00000_Main.Div);	column.setCellRenderer(B100_FrameParts.rightCellRenderer());
			}else {
				column = columnModel01.getColumn(1+(int)RtParameterMstWankoRt[i][1]);	column.setPreferredWidth( 90*A00000_Main.Mul/A00000_Main.Div);	column.setCellRenderer(B100_FrameParts.leftCellRenderer());
			}
		...
		SearchBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					GetSearchWhCd			= B100_TextControl.Trim(GetSearchWhCd);
				...
				if(RenewFg) {
					...
					for(int i=0;i<RowCount;i++) {
						if((boolean)MainFmTableModel.getValueAt(i, 0)) {
							TgtWhCd 		= ""+MainFmTableModel.getValueAt(i, M100_ParameterMstWankoRt.ColClWh+1);
							TgtClCd			= ""+MainFmTableModel.getValueAt(i, M100_ParameterMstWankoRt.ColClCd+1);
							TgtParaCd 		= ""+MainFmTableModel.getValueAt(i, M100_ParameterMstWankoRt.ColParaCd+1);
							TgtParaCdSeq	= ""+MainFmTableModel.getValueAt(i, M100_ParameterMstWankoRt.ColParaCdSeq+1);
						}
					}
					if(!"".equals(TgtParaCd) && !"".equals(TgtParaCdSeq)) {
						...
						WM100_ParameterMstWanko_01_RenewAndCreate.ParameterMstWankoRenewAndCreate(0,0,TgtWhCd,TgtClCd,TgtParaCd,TgtParaCdSeq);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WM100_ParameterMstWanko_01_RenewAndCreate.ParameterMstWankoRenewAndCreate(0,0,"","","","");
					RenewFg = true;
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100_ParameterMstWanko_02_ExcelEntry.ParameterMstWankoExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
		...
		CsvBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					RenewFg = false;
					B100_TableControl.TableOutPutCsv("出力先選択","荷主パラメータマスタ検索結果",tb01);
					RenewFg = true;
				}
			}
		});
		...
		ExcelBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					RenewFg = false;
					B100_TableControl.TableOutPutExcel("出力先選択","荷主パラメータマスタ検索結果",tb01);
					RenewFg = true;
				}
			}
		});
