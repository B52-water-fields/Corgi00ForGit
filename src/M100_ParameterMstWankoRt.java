...
public class M100_ParameterMstWankoRt{
	...
	*/
	...
	public static Object[][] DefinitionRt(){
		Object[][] Definition = {
					 {"String"		,null	,"Exact"		,ColSearchParaCd			,""											,"パラメータコード"		,""	,"Parameter Code"	,""	,"参数代码"	,""	,"Mã tham số"	,""}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaCdSeqStr	,""											,"ナンバリング"			,"最小"	,"Numbering"	,"Min"	,"编号"	,"最小"	,"Đánh số"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaCdSeqEnd	,""											,"ナンバリング"			,"最大"	,"Numbering"	,"Max"	,"编号"	,"最大"	,"Đánh số"	,"Tối đa"}
					,{"String"		,null	,"Partial"		,ColSearchParaName		,""											,"パラメータ名"			,""	,"Parameter Name"	,""	,"参数名称"	,""	,"Tên tham số"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt01		,""											,"テキスト項目01"		,""	,"Text Field 01"	,""	,"文本字段01"	,""	,"Trường văn bản 01"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt02		,""											,"テキスト項目02"		,""	,"Text Field 02"	,""	,"文本字段02"	,""	,"Trường văn bản 02"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt03		,""											,"テキスト項目03"		,""	,"Text Field 03"	,""	,"文本字段03"	,""	,"Trường văn bản 03"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt04		,""											,"テキスト項目04"		,""	,"Text Field 04"	,""	,"文本字段04"	,""	,"Trường văn bản 04"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt05		,""											,"テキスト項目05"		,""	,"Text Field 05"	,""	,"文本字段05"	,""	,"Trường văn bản 05"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt06		,""											,"テキスト項目06"		,""	,"Text Field 06"	,""	,"文本字段06"	,""	,"Trường văn bản 06"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt07		,""											,"テキスト項目07"		,""	,"Text Field 07"	,""	,"文本字段07"	,""	,"Trường văn bản 07"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt08		,""											,"テキスト項目08"		,""	,"Text Field 08"	,""	,"文本字段08"	,""	,"Trường văn bản 08"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt09		,""											,"テキスト項目09"		,""	,"Text Field 09"	,""	,"文本字段09"	,""	,"Trường văn bản 09"	,""}
					,{"String"		,null	,"Partial"		,ColSearchParaTxt10		,""											,"テキスト項目10"		,""	,"Text Field 10"	,""	,"文本字段10"	,""	,"Trường văn bản 10"	,""}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt01Str	,""											,"数値項目01"			,"最小"	,"Numeric Field 01"	,"Min"	,"数值字段01"	,"最小"	,"Trường số 01"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt02Str	,""											,"数値項目02"			,"最小"	,"Numeric Field 02"	,"Min"	,"数值字段02"	,"最小"	,"Trường số 02"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt03Str	,""											,"数値項目03"			,"最小"	,"Numeric Field 03"	,"Min"	,"数值字段03"	,"最小"	,"Trường số 03"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt04Str	,""											,"数値項目04"			,"最小"	,"Numeric Field 04"	,"Min"	,"数值字段04"	,"最小"	,"Trường số 04"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt05Str	,""											,"数値項目05"			,"最小"	,"Numeric Field 05"	,"Min"	,"数值字段05"	,"最小"	,"Trường số 05"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt06Str	,""											,"数値項目06"			,"最小"	,"Numeric Field 06"	,"Min"	,"数值字段06"	,"最小"	,"Trường số 06"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt07Str	,""											,"数値項目07"			,"最小"	,"Numeric Field 07"	,"Min"	,"数值字段07"	,"最小"	,"Trường số 07"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt08Str	,""											,"数値項目08"			,"最小"	,"Numeric Field 08"	,"Min"	,"数值字段08"	,"最小"	,"Trường số 08"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt09Str	,""											,"数値項目09"			,"最小"	,"Numeric Field 09"	,"Min"	,"数值字段09"	,"最小"	,"Trường số 09"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMin"		,ColSearchParaInt10Str	,""											,"数値項目10"			,"最小"	,"Numeric Field 10"	,"Min"	,"数值字段10"	,"最小"	,"Trường số 10"	,"Tối thiểu"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt01End	,""											,"数値項目01"			,"最大"	,"Numeric Field 01"	,"Max"	,"数值字段01"	,"最大"	,"Trường số 01"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt02End	,""											,"数値項目02"			,"最大"	,"Numeric Field 02"	,"Max"	,"数值字段02"	,"最大"	,"Trường số 02"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt03End	,""											,"数値項目03"			,"最大"	,"Numeric Field 03"	,"Max"	,"数值字段03"	,"最大"	,"Trường số 03"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt04End	,""											,"数値項目04"			,"最大"	,"Numeric Field 04"	,"Max"	,"数值字段04"	,"最大"	,"Trường số 04"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt05End	,""											,"数値項目05"			,"最大"	,"Numeric Field 05"	,"Max"	,"数值字段05"	,"最大"	,"Trường số 05"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt06End	,""											,"数値項目06"			,"最大"	,"Numeric Field 06"	,"Max"	,"数值字段06"	,"最大"	,"Trường số 06"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt07End	,""											,"数値項目07"			,"最大"	,"Numeric Field 07"	,"Max"	,"数值字段07"	,"最大"	,"Trường số 07"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt08End	,""											,"数値項目08"			,"最大"	,"Numeric Field 08"	,"Max"	,"数值字段08"	,"最大"	,"Trường số 08"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt09End	,""											,"数値項目09"			,"最大"	,"Numeric Field 09"	,"Max"	,"数值字段09"	,"最大"	,"Trường số 09"	,"Tối đa"}
					,{"Integer"		,null	,"RangeMax"		,ColSearchParaInt10End	,""											,"数値項目10"			,"最大"	,"Numeric Field 10"	,"Max"	,"数值字段10"	,"最大"	,"Trường số 10"	,"Tối đa"}
					,{"String"		,null	,"Partial"		,ColSearchParaTxtAll		,""											,"テキスト項目全件"		,""	,"All Text Fields"	,""	,"全部文本字段"	,""	,"Tất cả trường văn bản"	,""}
					,{"String"		,null	,"Exact"		,ColSearchClWh			,B100_DefaultVariable.SearchWhList		,"倉庫CD"				,""	,"Warehouse Code"	,""	,"仓库代码"	,""	,"Mã kho"	,""}
