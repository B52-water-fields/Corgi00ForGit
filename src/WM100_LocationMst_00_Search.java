				...
				if(RenewFg) {
					...
					for(int i=0;i<RowCount;i++) {
						if((boolean)tableModel_ms01.getValueAt(i, 0)) {
							TgtClCd = ""+tableModel_ms01.getValueAt(i, M100_LocationMstRt.ColClCd+1);
							TgtWhCd = ""+tableModel_ms01.getValueAt(i, M100_LocationMstRt.ColWhCd+1);
							TgtLoc 	= ""+tableModel_ms01.getValueAt(i, M100_LocationMstRt.ColLoc+1);
							KickFg = true;
						}
					}
					if(KickFg) {
