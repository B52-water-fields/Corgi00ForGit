...
public class WM100_ItemRecomendLocMst_00_Search{
	...
	public static void ItemRecomendLocMstSearch(int x,int y) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,900,750,"Corgi00推奨ロケマスタ検索　WM100_ItemRecomendLocMst_00_Search","");
				...
				if(RenewFg) {
					...
					for(int i=0;i<RowCount;i++) {
						if((boolean)MainFmTableModel.getValueAt(i, 0)) {
							TgtClCd		= ""+MainFmTableModel.getValueAt(i, M100_ItemRecomendLocMstRt.ColClCd+1);
							TgtWhCd		= ""+MainFmTableModel.getValueAt(i, M100_ItemRecomendLocMstRt.ColClWh+1);
							TgtItemCd	= ""+MainFmTableModel.getValueAt(i, M100_ItemRecomendLocMstRt.ColItemCd+1);
