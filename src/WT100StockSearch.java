	...
	public static void StockSearch(int x,int y) {
		...
		StockAdjustBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				...
				main_fm.dispose();
				WT100StockAdjust.StockAdjust(0,0,TgtWhCd,TgtClCd,TgtLoc,TgtItemCd,TgtLot,TgtExpdate,TgtActualDate);
			}
		});
		...
		ListPrintBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WTList100StockList.StockList(PrintData);
					RenewFg = true;
				}
			}
		});
