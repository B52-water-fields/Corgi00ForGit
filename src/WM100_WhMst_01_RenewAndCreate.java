...
public class WM100_WhMst_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	public static void WhMstRenewAndCreate(int x,int y,String TgtWhCd){
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,500,600,"Corgi00倉庫（事業所）登録・修正","");
		...
		final JTextField TB_Post  		= B100_FrameParts.JTextFieldSet(100, 90,100,20,"",11,0);	//拠点倉庫郵便番号
		final JTextField TB_Add01  		= B100_FrameParts.JTextFieldSet(100,115,250,20,"",11,0);	//拠点倉庫住所1
		final JTextField TB_Add02  		= B100_FrameParts.JTextFieldSet(100,140,250,20,"",11,0);	//拠点倉庫住所2
		final JTextField TB_Tel 		= B100_FrameParts.JTextFieldSet(100,165,100,20,"",11,0);	//拠点倉庫電話
		final JTextField TB_Fax  		= B100_FrameParts.JTextFieldSet(100,190,100,20,"",11,0);	//拠点倉庫FAX
		final JTextField TB_Mail 		= B100_FrameParts.JTextFieldSet(100,215,100,20,"",11,0);	//拠点倉庫MAIL
		final JTextField TB_Com01  		= B100_FrameParts.JTextFieldSet(100,240,250,20,"",11,0);	//コメント１
		final JTextField TB_Com02  		= B100_FrameParts.JTextFieldSet(100,265,250,20,"",11,0);	//コメント２
		final JTextField TB_Com03  		= B100_FrameParts.JTextFieldSet(100,290,250,20,"",11,0);	//コメント３
		final JTextField TB_PTMSCD 		= B100_FrameParts.JTextFieldSet(100,315,100,20,"",11,0);	//基幹SysCD
		...
		final JTextField TB_EntryUser  	= B100_FrameParts.JTextFieldSet(100,390,200,20,"",11,0);	//登録者
		final JTextField TB_UpdateUser  = B100_FrameParts.JTextFieldSet(100,415,200,20,"",11,0);	//更新者
		...
		if(!"".equals(TgtWhCd)) {
			...
			if(0<WhMstRt.length) {
				TB_WHCD.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoWHCD]);			//倉庫コード
				TB_WHName .setText(		""+WhMstRt[0][M100_WhMstRt.ColNoWHName]);			//拠点倉庫名
				TB_Post.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoPost]);			//拠点倉庫郵便番号
				TB_Add01.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoAdd01]);			//拠点倉庫住所1
				TB_Add02.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoAdd02]);			//拠点倉庫住所2
				TB_Tel.setText(			""+WhMstRt[0][M100_WhMstRt.ColNoTel]);			//拠点倉庫電話
				TB_Fax.setText(			""+WhMstRt[0][M100_WhMstRt.ColNoFax]);			//拠点倉庫FAX
				TB_Mail.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoMail]);			//拠点倉庫MAIL
				TB_Com01.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoCom01]);			//コメント１
				TB_Com02.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoCom02]);			//コメント２
				TB_Com03.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoCom03]);			//コメント３
				TB_PTMSCD.setText(		""+WhMstRt[0][M100_WhMstRt.ColNoPTMSCD]);			//基幹SysCD
				TB_EntryDate.setText(	""+WhMstRt[0][M100_WhMstRt.ColNoEntryDate]);		//データ登録日時
				TB_UpdateDate.setText(	""+WhMstRt[0][M100_WhMstRt.ColNoUpdateDate]);	//データ更新日時
				TB_EntryUser.setText(	""+WhMstRt[0][M100_WhMstRt.ColNoEntryUser]);		//登録者
				TB_UpdateUser.setText(	""+WhMstRt[0][M100_WhMstRt.ColNoUpdateUser]);	//更新者
			}
		}
		main_fm.add(LB_WHCD);
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				...
				if("".equals(GetWHCD)) {GetWHCD = M100_WhMstRt.NewWhCdGet(1)[0];}
				...
				if(KickFg) {	
					String SetWh = B100_DefaultVariableWarehouse.RenewAndCreateWh(
							GetWHCD,	//倉庫コード
							GetWHName,	//拠点倉庫名
							GetPost,	//拠点倉庫郵便番号
							GetAdd01,	//拠点倉庫住所1
