...
public class WTList100_ArrivalPlan{
			...
			if(NewPrintOnly) {
				for(int i=0;i<ArrNoList.size();i++) {
					...
					for(int i01=0;i01<PrintControlRt.length;i01++) {
						if(((String)PrintControlRt[i01][T100_PrintControlRt.ColOkuriNo]).equals(ArrNoList.get(i))) {
							UnHitFg = false;
				 ...
				 try {
			        ...
			        ******************************************************************/
			        ...
			        for(int i01=0;i01<ArrivalPlanHdRt.length;i01++) {
			        	HdPageCount[i01][0] = (String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColClWh];
			        	HdPageCount[i01][1] = (String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColClCd];
			        	HdPageCount[i01][2] = (String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColArrNo];
			        	...
			        	for(int i02=0;i02<ArrivalPlanMsRt.length;i02++) {
			        		if(
		        				((String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColClWh]).equals((String)ArrivalPlanMsRt[i02][T100_ArrivalPlanMsRt.ColClWh])
		        				&&((String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColClCd]).equals((String)ArrivalPlanMsRt[i02][T100_ArrivalPlanMsRt.ColClCd])
		        				&&((String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColArrNo]).equals((String)ArrivalPlanMsRt[i02][T100_ArrivalPlanMsRt.ColArrNo])
		        				) {
			        	...
			        	if(!NewPrintOnly) {
			        		for(int i02=0;i02<PrintControlRt.length;i02++) {
								if(((String)PrintControlRt[i02][T100_PrintControlRt.ColOkuriNo]).equals((String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColArrNo])
										&&((String)PrintControlRt[i02][T100_PrintControlRt.ColKey01]).equals((String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColClWh])			//サブキー01
										&&((String)PrintControlRt[i02][T100_PrintControlRt.ColKey02]).equals((String)ArrivalPlanHdRt[i01][T100_ArrivalPlanHdRt.ColClCd])			//サブキー02
										) {
									HdPageCount[i01][4] = (boolean)true;
									HdPageCount[i01][5] = (String)PrintControlRt[i02][T100_PrintControlRt.ColUpdateDate];
								}
							}
			        	}
			        }
			        ...
			        for(int i01=0;i01<ArrivalPlanHdRt.length;i01++) {
			        	...
			        	for(int i02=0;i02<ArrivalPlanMsRt.length;i02++) {
			        		if(
			        			...
			        			//明細生成
			        			MsCount=MsCount+1;
			        			int BaraQty = (int)ArrivalPlanMsRt[i02][T100_ArrivalPlanMsRt.ColPlanQty];
			        			int CtQty = 0;
			        			int CsQty = 0;
			        			int PlQty = 0;
			        			String RecomendLoc = "";
			        			...
			        			for(int i03=0;i03<ItemMstRt.length;i03++){
			        				if(((String)ArrivalPlanMsRt[i02][T100_ArrivalPlanMsRt.ColItemCd]).equals((String)ItemMstRt[i03][M100_ItemMstRt.ColItemCd])) {
			        					GetCtQty	= (int)ItemMstRt[i03][M100_ItemMstRt.ColCtQty];					//カートン入数
			        					GetCsQty	= (int)ItemMstRt[i03][M100_ItemMstRt.ColCsQty];					//ケース入数
			        					GetPlQty	= (int)ItemMstRt[i03][M100_ItemMstRt.ColPlQty];					//パレット入数
			        					GetBrUnitName	= (String)ItemMstRt[i03][M100_ItemMstRt.ColUnitName];
			        					GetCtUnitName	= (String)ItemMstRt[i03][M100_ItemMstRt.ColCtUnitName];
			        					GetCsUnitName	= (String)ItemMstRt[i03][M100_ItemMstRt.ColCsUnitName];
			        					GetPlUnitName	= (String)ItemMstRt[i03][M100_ItemMstRt.ColPlUnitName];
	...
	private static PDPageContentStream Ms(
		...
		SetText = ""+(String)ArrivalPlanMsRt[T100_ArrivalPlanMsRt.ColItemCd];	//商品CD
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream, 20,(float)HeightStart-10-(leading*PageRow*2)+leading*2,120,leading,SetText,font,FontSize-2,Color.BLACK,0,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        SetText = ""+ni.format((int)ArrivalPlanMsRt[T100_ArrivalPlanMsRt.ColPlanQty])+""+GetBrUnitName;	//総バラ数
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream, 20,(float)HeightStart-10-(leading*PageRow*2)+leading*1,120,leading,SetText,font,FontSize-2,Color.BLACK,1,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        
        SetText =  ""+(String)ArrivalPlanMsRt[T100_ArrivalPlanMsRt.Collot];	//ロット
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream,140,(float)HeightStart-10-(leading*PageRow*2)+leading*2,100,leading,SetText,font,FontSize-2,Color.BLACK,0,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        SetText =  ""+(String)ArrivalPlanMsRt[T100_ArrivalPlanMsRt.ColExpDate];	//賞味期限
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream,140,(float)HeightStart-10-(leading*PageRow*2)+leading*1,100,leading,SetText,font,FontSize-2,Color.BLACK,0,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        
        SetText =  ""+ni.format(BaraQty)+""+GetBrUnitName;	//バラ数
        if(0==BaraQty) {SetText="";}
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream,240,(float)HeightStart-10-(leading*PageRow*2)+leading*2, 80,leading,SetText,font,FontSize-2,Color.BLACK,1,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        
        wint = CsQty*GetCsQty;
        SetText =  ""+ni.format(CsQty)+" "+GetCsUnitName+"("+ni.format(wint)+GetBrUnitName+")";	//ケース数
        if(0==CsQty) {SetText="";}
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream,240,(float)HeightStart-10-(leading*PageRow*2)+leading*1, 80,leading,SetText,font,FontSize-2,Color.BLACK,1,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        
        wint = CtQty*GetCtQty;
        SetText =  ""+ni.format(CtQty)+" "+GetCtUnitName+"("+ni.format(wint)+GetBrUnitName+")";	//カートン数
        if(0==CtQty) {SetText="";}
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream,320,(float)HeightStart-10-(leading*PageRow*2)+leading*2, 80,leading,SetText,font,FontSize-2,Color.BLACK,1,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        
        wint = PlQty*GetPlQty;
        SetText =  ""+ni.format(PlQty)+" "+GetPlUnitName+"("+ni.format(wint)+GetBrUnitName+")";	//パレット数
        if(0==PlQty) {SetText="";}
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream,320,(float)HeightStart-10-(leading*PageRow*2)+leading*1, 80,leading,SetText,font,FontSize-2,Color.BLACK,1,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        
        SetText = ""+RecomendLoc;	//推奨ロケ
        contentStream = B100_PdfControl.TextSetBox(contentStream,400,(float)HeightStart-10-(leading*PageRow*2)+leading*2,100,leading*2,SetText,font,FontSize-2,Color.BLACK,0,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
        
        SetText =  ""+(String)ArrivalPlanMsRt[T100_ArrivalPlanMsRt.ColItemName];	//商品名
        contentStream = B100_PdfControl.TextSetBox(contentStream,500,(float)HeightStart-10-(leading*PageRow*2)+leading*2,300,leading*2,SetText,font,FontSize-2,Color.BLACK,0,true,Color.BLACK,SetBackgrpundFg,BackgroundColor);
	...
	private static PDPageContentStream Hedder(
		...
		contentStream = B100_PdfControl.TextSetBox(contentStream, 0,(float)HeightStart-leading*0,20,leading,SetText,font,FontSize,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
		
		SetText =  "　　　荷主:("+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColClCd]+")"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColCLName01];
        contentStream = B100_PdfControl.TextSetBox(contentStream, 20,(float)HeightStart-leading*0,500,leading,SetText,font,FontSize-2,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        SetText = "　発行日時："+CreateDtm;
        contentStream = B100_PdfControl.TextSetBox(contentStream,520,(float)HeightStart-leading*0,300,leading,SetText,font,FontSize-2,Color.BLACK,1,false,Color.BLACK,false,Color.WHITE);
        
        SetText = "　　仕入先:("+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColSpCd]+")"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColSpName01];
        contentStream = B100_PdfControl.TextSetBox(contentStream, 20,(float)HeightStart-leading*1,500,leading,SetText,font,FontSize-2,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        SetText = "予定Noページ:"+HdPage+"/"+HdPageCount+" 発行総ページ:"+PageCount+"/"+TotalPageCount;
        contentStream = B100_PdfControl.TextSetBox(contentStream,520,(float)HeightStart-leading*1,300,leading,SetText,font,FontSize-2,Color.BLACK,1,false,Color.BLACK,false,Color.WHITE);
		
		SetText = "入荷予定No:"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColArrNo];
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream, 20,(float)HeightStart-leading*2,150,leading,SetText,font,FontSize-2,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        
        SetText = "荷主管理No:"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColClArrNo];
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream, 20,(float)HeightStart-leading*3,150,leading,SetText,font,FontSize-2,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        
        SetText =  "入荷予定日:"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColPlanDate];
        contentStream = B100_PdfControl.TextSetBoxFontAdjust(contentStream, 20,(float)HeightStart-leading*4,150,leading,SetText,font,FontSize-2,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        
        
        
        SetText =  "備考01:"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColArCom01];
        contentStream = B100_PdfControl.TextSetBox(contentStream,370,(float)HeightStart-leading*2,450,leading,SetText,font,FontSize-3,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        
        SetText =  "備考02:"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColArCom02];
        contentStream = B100_PdfControl.TextSetBox(contentStream,370,(float)HeightStart-leading*3,450,leading,SetText,font,FontSize-3,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        
        SetText =  "備考03:"+(String)ArrivalPlanHdRt[T100_ArrivalPlanHdRt.ColArCom03];
        contentStream = B100_PdfControl.TextSetBox(contentStream,370,(float)HeightStart-leading*4,450,leading,SetText,font,FontSize-3,Color.BLACK,0,false,Color.BLACK,false,Color.WHITE);
        ...
        contentStream = B100_PdfControl.TextSetBox(contentStream,520,(float)HeightStart-leading*5,300,leading,SetText,font,FontSize-2,Color.BLACK,1,false,Color.BLACK,false,Color.WHITE);
        ...
        SetText = "商品CD";
        contentStream = B100_PdfControl.TextSetBox(contentStream, 20,(float)HeightStart-5-leading*6,120,leading,SetText,font,FontSize-2,Color.BLACK,0,true,Color.BLACK,true,BackgroundColor);
        SetText = "総バラ数";
        contentStream = B100_PdfControl.TextSetBox(contentStream, 20,(float)HeightStart-5-leading*7,120,leading,SetText,font,FontSize-2,Color.BLACK,1,true,Color.BLACK,true,BackgroundColor);
        
        SetText =  "ロット";
        contentStream = B100_PdfControl.TextSetBox(contentStream,140,(float)HeightStart-5-leading*6,100,leading,SetText,font,FontSize-2,Color.BLACK,2,true,Color.BLACK,true,BackgroundColor);
        SetText =  "賞味期限";
        ...
        SetText =  "商品名";
        contentStream = B100_PdfControl.TextSetBox(contentStream,500,(float)HeightStart-5-leading*6,300,leading*2,SetText,font,FontSize-2,Color.BLACK,2,true,Color.BLACK,true,BackgroundColor);
        
        
        SetText =  "WTList100_ArrivalPlan";//修正時に探しやすくするためにクラス名
	...
	private static String OutPutPath() {
		...
		FLD_PATH = A00000_Main.MainFLD+"\\ArrivalPlan\\ArrivalPlanList0001";
		B100_FolderCheck.FLD_CHECK(FLD_PATH);
		...
		//古いデータ削除
		B100_FolderCheck.ToolsOldFileDeleteWhereFileName(FLD_PATH ,"ArrivalPlanList0001",B100_DefaultVariable.ErrTxtDelete);
	...
	private static Object[][] PrintDataGet(String TgtWhCd,String TgtClCd,ArrayList<String> TgtArrNo) {
		...
		Object[][] PrintControlRt	= T100_PrintControlRt.PrintControlRt(
	...
	private static void PrintEntry(String TgtWhCd,String TgtClCd,ArrayList<String> TgtArrNo) {
		...
		A100_InsertUpdateSQL.InsertUpdateSomeRecord(SetOb,Hd_tgt_table,Hd_TgtDB,Hd_non_msg_fg);
	}
}
