...
public class WM100ParameterMstNyankoSeach{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtParaCd) && !"".equals(TgtParaCdSeq)) {
						...
						WM100ParameterMstNyankoRenewAndCreate.ParameterMstNyankoRenewAndCreate(0,0,TgtParaCd,TgtParaCdSeq);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WM100ParameterMstNyankoRenewAndCreate.ParameterMstNyankoRenewAndCreate(0,0,"","");
					RenewFg = true;
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100ParameterMstNyankoExcelEntry.ParameterMstNyankoExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
