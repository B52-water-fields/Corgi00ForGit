		...
		if(SearchKick) {
			...
			try {
				...
				while (rset01.next()) {
					...
					if(null==rset01.getTimestamp("ActualDate"	)){rt[counter][ColActualDate]		="";}else{rt[counter][ColActualDate]	=B100_DateTimeControl.dtmString2(rset01.getTimestamp("ActualDate"))[1];}		//ヘッダ入荷実績日
					...
					if(null==rset01.getTimestamp("EntryDate"	)){rt[counter][ColEntryDate]		="";}else{rt[counter][ColEntryDate]	=B100_DateTimeControl.dtmString2(rset01.getTimestamp("EntryDate"))[1];}			//ヘッダ登録日
					if(null==rset01.getTimestamp("UpdateDate"	)){rt[counter][ColUpdateDate]		="";}else{rt[counter][ColUpdateDate]	=B100_DateTimeControl.dtmString2(rset01.getTimestamp("UpdateDate"))[1];}		//ヘッダ更新日
