...
public class WMTools100_ItemComversion{
	...
	*/
	...
	public static Object[][] ItemComversion(String ClCd,ArrayList<String> ClItemCd){
		ClItemCd	= B100_ArrayListControl.ArryListStringUniqueList(ClItemCd);
		...
		for(int i=0;i<rt.length;i++) {
			...
			if(null==rt[i][ColItemCd]||"".equals(rt[i][ColItemCd])) {				
				for(int i01=0;i01<ItemComversionMstRt.length;i01++) {
					String GetClItemCd		= (String)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColClItemCd];	//荷主商品コード
					if(CheckClItemCd.equals(GetClItemCd)){
						...
						int GetCtQty			= (int)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColCtQty];			//カートン入数
						int GetCsQty			= (int)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColCsQty];			//ケース入数
						int GetPlQty			= (int)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColPlQty];			//パレット入数
						String GetUnitName		= (String)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColUnitName];		//商品単位
						String GetCtUnitName	= (String)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColCtUnitName];	//カートン商品単位
						String GetCsUnitName	= (String)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColCsUnitName];	//ケース商品単位
						String GetPlUnitName	= (String)ItemComversionMstRt[i01][M100_ItemComversionMstRt.ColPlUnitName];	//パレット商品単位
