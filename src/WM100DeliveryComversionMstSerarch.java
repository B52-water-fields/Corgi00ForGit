...
public class WM100DeliveryComversionMstSerarch{
	static int SetX;
	static int SetY;
				...
				if(RenewFg) {
					...
					for(int i=0;i<RowCount;i++) {
						if((boolean)tableModel_ms01.getValueAt(i, 0)) {
							...
							WM100DeliveryComversionMstRenewAndCreate.DeliveryComversionMstRenewAndCreate(0,0,""+tableModel_ms01.getValueAt(i, 1),""+tableModel_ms01.getValueAt(i, 3));
						}
					}
					RenewFg = true;
				}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WM100DeliveryComversionMstRenewAndCreate.DeliveryComversionMstRenewAndCreate(0,0,"","");
					RenewFg = true;
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100DeliveryComversionMstExcelEntry.DeliveryComversionMstExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
