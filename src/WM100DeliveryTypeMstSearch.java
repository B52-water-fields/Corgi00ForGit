...
public class WM100DeliveryTypeMstSearch{
	static int SetX;
	static int SetY;
	...
	public static void DeliveryTypeMstSearch(int x,int y) {
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtDeliveryTypeNo) && !"".equals(TgtDeliveryTypeCd)) {
						...
						main_fm.dispose();
						WM100DeliveryTypeMstRenewAndCreate.DeliveryTypeMstRenewAndCreate(0,0,TgtDeliveryTypeNo,TgtDeliveryTypeCd);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				...
				main_fm.setVisible(false);
				main_fm.dispose();
				WM100DeliveryTypeMstRenewAndCreate.DeliveryTypeMstRenewAndCreate(0,0,"","");
			}
		});
