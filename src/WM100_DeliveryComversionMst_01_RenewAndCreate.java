...
public class WM100_DeliveryComversionMst_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	...
	public static void DeliveryComversionMstRenewAndCreate(int x,int y,String ClGpCD,final String CL_DECD) {
		...
		JLabel LB_DEName01				= B100_FrameParts.JLabelSet(  0,165,100,20,"届先名1:"			,	11,1);
		JLabel LB_DEName02				= B100_FrameParts.JLabelSet(  0,190,100,20,"届先名2:"			,	11,1);
		JLabel LB_DEName03				= B100_FrameParts.JLabelSet(  0,215,100,20,"届先名3:"			,	11,1);
		...
		final JTextField  TB_DECD				= B100_FrameParts.JTextFieldSet(	100,115,100,20,"",11,0);			//届先CD
		final JTextField  TB_DepartmentCd		= B100_FrameParts.JTextFieldSet(	100,140,100,20,"",11,0);			//届先部署CD
		final JTextField  TB_DEName01			= B100_FrameParts.JTextFieldSet(	100,165,200,20,"",11,0);			//届先名1
		final JTextField  TB_DEName02			= B100_FrameParts.JTextFieldSet(	100,190,200,20,"",11,0);			//届先名2
		final JTextField  TB_DEName03			= B100_FrameParts.JTextFieldSet(	100,215,200,20,"",11,0);			//届先名3
		final JTextField  TB_Post				= B100_FrameParts.JTextFieldSet(	100,240,100,20,"",11,0);			//届先郵便
		final JTextField  TB_Add01				= B100_FrameParts.JTextFieldSet(	100,265,200,20,"",11,0);			//届先住所1
		final JTextField  TB_Add02				= B100_FrameParts.JTextFieldSet(	100,290,200,20,"",11,0);			//届先住所2
		final JTextField  TB_Add03				= B100_FrameParts.JTextFieldSet(	100,315,200,20,"",11,0);			//届先住所3
		final JTextField  TB_Tel				= B100_FrameParts.JTextFieldSet(	100,340,100,20,"",11,0);			//届先電話
		final JTextField  TB_Fax				= B100_FrameParts.JTextFieldSet(	100,365,100,20,"",11,0);			//届先FAX
		final JTextField  TB_Mail				= B100_FrameParts.JTextFieldSet(	100,390,200,20,"",11,0);			//届先MAIL
		final JTextField  TB_SetName			= B100_FrameParts.JTextFieldSet(	100,415,200,20,"",11,0);			//送り状登録名
		final JTextField  TB_Com01				= B100_FrameParts.JTextFieldSet(	100,440,200,20,"",11,0);			//コメント01
		final JTextField  TB_Com02				= B100_FrameParts.JTextFieldSet(	100,465,200,20,"",11,0);			//コメント02
		final JTextField  TB_Com03				= B100_FrameParts.JTextFieldSet(	100,490,200,20,"",11,0);			//コメント03
		final JTextField  TB_Com04				= B100_FrameParts.JTextFieldSet(	100,515,200,20,"",11,0);			//コメント04
		final JTextField  TB_Com05				= B100_FrameParts.JTextFieldSet(	100,540,200,20,"",11,0);			//コメント05
		final JComboBox   TB_DelFg				= B100_FrameParts.JComboBoxSet( 	100,565,150,20,B100_DefaultVariable.DelList[0],11);	//削除区分
		final JComboBox   TB_MstPriorityFirstFg	= B100_FrameParts.JComboBoxSet( 	100,590,150,20,PriorityFirstFg,11);						//届先マスタ優先
		final JTextField  TB_EntryDate			= B100_FrameParts.JTextFieldSet(	100,615,200,20,"",11,0);			//データ登録日時
		final JTextField  TB_UpdateDate			= B100_FrameParts.JTextFieldSet(	100,640,200,20,"",11,0);			//データ更新日時
		final JTextField  TB_EntryUser			= B100_FrameParts.JTextFieldSet(	100,665,200,20,"",11,0);			//登録者コード
		final JTextField  TB_UpdateUser			= B100_FrameParts.JTextFieldSet(	100,690,200,20,"",11,0);			//更新者コード
		...
		if(!"".equals(ClGpCD)) {
			...
			if(0<ClGpMstRt.length) {
				TB_CLGpName01.setText(""+ClGpMstRt[0][M100_ClGpMstRt.ColCLGpName01]);
			}
		}
		...
		if(null==CL_DECD) {
			...
			if(!"".equals(CL_DECD)) {
				...
				if(0<DeliveryComversionMstRt.length) {
					TB_ClGpCD.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColClGpCD]);
					TB_CLGpName01.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColCLGpName01]);
					TB_CL_DECD.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColCL_DECD]);
					TB_DECD.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColDECD]);
					TB_DepartmentCd.setText(""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColDepartmentCd]);
					TB_DEName01.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColDEName01]);
					TB_DEName02.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColDEName02]);
					TB_DEName03.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColDEName03]);
					TB_Post.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColPost]);
					TB_Add01.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColAdd01]);
					TB_Add02.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColAdd02]);
					TB_Add03.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColAdd03]);
					TB_Tel.setText(			""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColTel]);
					TB_Fax.setText(			""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColFax]);
					TB_Mail.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColMail]);
					TB_SetName.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColSetName]);
					TB_Com01.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColCom01]);
					TB_Com02.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColCom02]);
					TB_Com03.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColCom03]);
					TB_Com04.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColCom04]);
					TB_Com05.setText(		""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColCom05]);
					for(int i=0;i<B100_DefaultVariable.DelList[1].length;i++) {
						if(B100_DefaultVariable.DelList[1][i].equals(""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColDelFg])) {
							TB_DelFg.setSelectedIndex(i);
						}
					}
					if(1==(int)DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColMstPriorityFirstFg]){TB_MstPriorityFirstFg.setSelectedIndex(1);}else {TB_MstPriorityFirstFg.setSelectedIndex(0);}
					TB_EntryDate.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColEntryDate]);
					TB_UpdateDate.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColUpdateDate]);
					TB_EntryUser.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColEntryUser]);
					TB_UpdateUser.setText(	""+DeliveryComversionMstRt[0][M100_DeliveryComversionMstRt.ColUpdateUser]);
				}
			}
		}
		
		final JCheckBox DeliveryRenewMode = B100_FrameParts.JCheckBoxSet(220,140,200,20,"届先修正モード",11);
		...
		//届先検索ボタン
		JButton SearchBtn = B100_FrameParts.BtnSet(220,115,100,20,"届先検索",11);
		...
		final JTextField  TB_SearchDEName			= B100_FrameParts.JTextFieldSet(	100, 90,100,20,"",11,0);			//届先名
		final JTextField  TB_SearchAdd				= B100_FrameParts.JTextFieldSet(	100,115,100,20,"",11,0);			//住所
		final JTextField  TB_SearchTel				= B100_FrameParts.JTextFieldSet(	100,140,100,20,"",11,0);			//電話
		
		final JTextField  TB_SearchPost				= B100_FrameParts.JTextFieldSet(	300, 40,100,20,"",11,0);			//郵便
		...
		//スクロール用設定
		JScrollPane scpn01 = B100_FrameParts.JScrollPaneSet(10,165,610,335,tb01);
		DeliSearch_fm.add(scpn01);
		
		JLabel LB_RenewBtn  = B100_FrameParts.JLabelSet(	520,520,100,20,"チェック行を" ,11,2);
		DeliSearch_fm.add(LB_RenewBtn);
		
		//選択ボタン
		JButton RenewBtn = B100_FrameParts.BtnSet(		520,540,100,20,"選択",11);
		...
		DeliSearchBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					String GetSearchDepartmentCd	= B100_FramePartsControl.JTextFieldRt(TB_SearchDepartmentCd);
					String GetSearchDEName			= B100_FramePartsControl.JTextFieldRt(TB_SearchDEName);
					String GetSearchAdd				= B100_FramePartsControl.JTextFieldRt(TB_SearchAdd);
					String GetSearchTel				= B100_FramePartsControl.JTextFieldRt(TB_SearchTel);
					
					String GetSearchPost			= B100_FramePartsControl.JTextFieldRt(TB_SearchPost);
					String GetSearchFax				= B100_FramePartsControl.JTextFieldRt(TB_SearchFax);
					String GetSearchMail			= B100_FramePartsControl.JTextFieldRt(TB_SearchMail);
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					String GetClGpCD		= B100_FramePartsControl.JTextFieldRt(TB_ClGpCD);
					String GetCL_DECD		= B100_FramePartsControl.JTextFieldRt(TB_CL_DECD);
					String GetDECD			= B100_FramePartsControl.JTextFieldRt(TB_DECD);
					String GetDepartmentCd	= B100_FramePartsControl.JTextFieldRt(TB_DepartmentCd);
					String GetDEName01		= B100_FramePartsControl.JTextFieldRt(TB_DEName01);
					String GetDEName02		= B100_FramePartsControl.JTextFieldRt(TB_DEName02);
					String GetDEName03		= B100_FramePartsControl.JTextFieldRt(TB_DEName03);
					String GetPost			= B100_FramePartsControl.JTextFieldRt(TB_Post);
					String GetAdd01			= B100_FramePartsControl.JTextFieldRt(TB_Add01);
					String GetAdd02			= B100_FramePartsControl.JTextFieldRt(TB_Add02);
					String GetAdd03			= B100_FramePartsControl.JTextFieldRt(TB_Add03);
					String GetTel			= B100_FramePartsControl.JTextFieldRt(TB_Tel);
					String GetFax			= B100_FramePartsControl.JTextFieldRt(TB_Fax);
					String GetMail			= B100_FramePartsControl.JTextFieldRt(TB_Mail);
					String GetSetName		= B100_FramePartsControl.JTextFieldRt(TB_SetName);
					String GetCom01			= B100_FramePartsControl.JTextFieldRt(TB_Com01);
					String GetCom02			= B100_FramePartsControl.JTextFieldRt(TB_Com02);
					String GetCom03			= B100_FramePartsControl.JTextFieldRt(TB_Com03);
					String GetCom04			= B100_FramePartsControl.JTextFieldRt(TB_Com04);
					String GetCom05			= B100_FramePartsControl.JTextFieldRt(TB_Com05);
					...
					if(!"".equals(GetCL_DECD)) {
						...
						if(DeliveryRenewFg) {
							if("".equals(GetDEName01)) {
								...
								if(!DeliveryCheckNG) {
									//届先コード空白なら新規採番
									if("".equals(GetDECD)) {GetDECD = M100_DeliveryMstRt.DeliveryCdGet(1)[0];}
									//届先部署コード空白なら"0000"
						...
						if(KickFg) {
							if(!"".equals(GetDECD) && !"".equals(GetDepartmentCd)) {
								...
								main_fm.dispose();
								WM100_DeliveryComversionMst_01_RenewAndCreate.DeliveryComversionMstRenewAndCreate(0,0,GetClGpCD,GetCL_DECD);
							}else {
	...
	private static void DeliveryMstEntry(
		...
		if("".equals(GetJis)) {
			...
			GetJis = ""+M100_PostMstRt.AddToMunicipality(AddList)[0][1];
		}
		if(2<GetJis.length()) {
		...
		String[][] SetString = {
				...
				,{"LastClient"		,"1","1",A00000_Main.ClCd}			//更新した荷主CD
				,{"DelFg"			,"1","1","0"}						//削除区分
				};
