...
public class WM100_DeliveryTypeMst_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	...
	public static void DeliveryTypeMstRenewAndCreate(int x,int y,String DeliveryTypeNo,String DeliveryTypeCd) {
		...
		final JTextField TB_DeliveryTypeName		= B100_FrameParts.JTextFieldSet(100, 90,150,20,"",11,0);			//運送タイプ名
		final JTextField TB_EntryDate				= B100_FrameParts.JTextFieldSet(100,115,250,20,"",11,0);			//データ登録日時
		final JTextField TB_UpdateDate				= B100_FrameParts.JTextFieldSet(100,140,250,20,"",11,0);			//データ更新日時
		final JTextField TB_EntryUser				= B100_FrameParts.JTextFieldSet(100,165,250,20,"",11,0);			//登録者コード
		final JTextField TB_UpdateUser				= B100_FrameParts.JTextFieldSet(100,190,250,20,"",11,0);			//更新者コード
		...
		if(!"".equals(DeliveryTypeNo)&& !"".equals(DeliveryTypeCd)) {
			...
			if(0<DeliveryTypeMstRt.length) {
				TB_SearchDeliveryTypeNo.setSelectedIndex((int)DeliveryTypeMstRt[0][M100_DeliveryTypeMstRt.ColDeliveryTypeNo]-1);
				TB_DeliveryTypeCd.setText(		""+DeliveryTypeMstRt[0][M100_DeliveryTypeMstRt.ColDeliveryTypeCd]);
				TB_DeliveryTypeName.setText(	""+DeliveryTypeMstRt[0][M100_DeliveryTypeMstRt.ColDeliveryTypeName]);
				TB_EntryDate.setText(			""+DeliveryTypeMstRt[0][M100_DeliveryTypeMstRt.ColEntryDate]);
				TB_UpdateDate.setText(			""+DeliveryTypeMstRt[0][M100_DeliveryTypeMstRt.ColUpdateDate]);
				TB_EntryUser.setText(			""+DeliveryTypeMstRt[0][M100_DeliveryTypeMstRt.ColEntryUser]);
				TB_UpdateUser.setText(			""+DeliveryTypeMstRt[0][M100_DeliveryTypeMstRt.ColUpdateUser]);
			}
		}
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					GetDeliveryTypeCd		= B100_TextControl.Trim(GetDeliveryTypeCd);
					GetDeliveryTypeName		= B100_TextControl.Trim(GetDeliveryTypeName);
					
					GetDeliveryTypeCd		= B100_TextControl.only1byte_String(GetDeliveryTypeCd);
					...
					if(!"".equals(GetSearchDeliveryTypeNo)&&!"".equals(GetDeliveryTypeCd)&&!"".equals(GetDeliveryTypeName)) {
						...
						B100_DefaultVariable.DeliveryType();
						...
						WM100_DeliveryTypeMst_01_RenewAndCreate.DeliveryTypeMstRenewAndCreate(0,0,GetSearchDeliveryTypeNo,GetDeliveryTypeCd);
