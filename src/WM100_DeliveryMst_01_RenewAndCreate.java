...
public class WM100_DeliveryMst_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	...
	public static void DeliveryMstRenewAndCreate(int x,int y,String DECD,String DepartmentCd) {
		...
		JLabel LB_DECD				= B100_FrameParts.JLabelSet(  0, 40,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColDECD][3]				+":",	11,1);
		JLabel LB_DepartmentCd		= B100_FrameParts.JLabelSet(  0, 65,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColDepartmentCd][3]	+":",	11,1);
		JLabel LB_DEName01			= B100_FrameParts.JLabelSet(  0, 90,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColDEName01][3]		+":",	11,1);
		JLabel LB_DEName02			= B100_FrameParts.JLabelSet(  0,115,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColDEName02][3]		+":",	11,1);
		JLabel LB_DEName03			= B100_FrameParts.JLabelSet(  0,140,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColDEName03][3]		+":",	11,1);
		JLabel LB_Post				= B100_FrameParts.JLabelSet(  0,165,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColPost][3]				+":",	11,1);
		JLabel LB_Add01				= B100_FrameParts.JLabelSet(  0,190,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColAdd01][3]			+":",	11,1);
		JLabel LB_Add02				= B100_FrameParts.JLabelSet(  0,215,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColAdd02][3]			+":",	11,1);
		JLabel LB_Add03				= B100_FrameParts.JLabelSet(  0,240,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColAdd03][3]			+":",	11,1);
		JLabel LB_Tel				= B100_FrameParts.JLabelSet(  0,265,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColTel][3]				+":",	11,1);
		JLabel LB_Fax				= B100_FrameParts.JLabelSet(  0,290,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColFax][3]				+":",	11,1);
		JLabel LB_Mail				= B100_FrameParts.JLabelSet(  0,315,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColMail][3]				+":",	11,1);
		JLabel LB_Com01				= B100_FrameParts.JLabelSet(  0,340,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColCom01][3]			+":",	11,1);
		JLabel LB_Com02				= B100_FrameParts.JLabelSet(  0,365,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColCom02][3]			+":",	11,1);
		JLabel LB_Com03				= B100_FrameParts.JLabelSet(  0,390,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColCom03][3]			+":",	11,1);
		JLabel LB_PrefecturesCd		= B100_FrameParts.JLabelSet(  0,415,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColPrefecturesCd][3]	+":",	11,1);
		JLabel LB_MunicipalityCd	= B100_FrameParts.JLabelSet(  0,440,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColMunicipalityCd][3]	+":",	11,1);
		JLabel LB_PTMSCD			= B100_FrameParts.JLabelSet(  0,465,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColPTMSCD][3]			+":",	11,1);
		JLabel LB_EntryDate			= B100_FrameParts.JLabelSet(  0,490,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColEntryDate][3]		+":",	11,1);
		JLabel LB_UpdateDate		= B100_FrameParts.JLabelSet(  0,515,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColUpdateDate][3]		+":",	11,1);
		JLabel LB_EntryUser			= B100_FrameParts.JLabelSet(  0,540,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColEntryUser][3]		+":",	11,1);
		JLabel LB_UpdateUser		= B100_FrameParts.JLabelSet(  0,565,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColUpdateUser][3]		+":",	11,1);
		JLabel LB_FirstClient		= B100_FrameParts.JLabelSet(  0,590,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColFirstClient][3]		+":",	11,1);
		JLabel LB_LastClient		= B100_FrameParts.JLabelSet(  0,615,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColLastClient][3]		+":",	11,1);
		JLabel LB_DelFg				= B100_FrameParts.JLabelSet(  0,640,100,20,(String)RtDeliveryMstRt[M100_DeliveryMstRt.ColDelFg][3]			+":",	11,1);
		...
		final JTextField TB_Add03			= B100_FrameParts.JTextFieldSet(100,240,250,20,"",11,0);			//届先住所3
		final JTextField TB_Tel				= B100_FrameParts.JTextFieldSet(100,265,100,20,"",11,0);			//届先電話
		final JTextField TB_Fax				= B100_FrameParts.JTextFieldSet(100,290,100,20,"",11,0);			//届先FAX
		final JTextField TB_Mail			= B100_FrameParts.JTextFieldSet(100,315,100,20,"",11,0);			//届先MAIL
		final JTextField TB_Com01			= B100_FrameParts.JTextFieldSet(100,340,250,20,"",11,0);			//コメント1
		final JTextField TB_Com02			= B100_FrameParts.JTextFieldSet(100,365,250,20,"",11,0);			//コメント2
		final JTextField TB_Com03			= B100_FrameParts.JTextFieldSet(100,390,250,20,"",11,0);			//コメント3
		final JTextField TB_PrefecturesCd	= B100_FrameParts.JTextFieldSet(100,415,100,20,"",11,0);			//JIS県CD2桁
		final JTextField TB_MunicipalityCd	= B100_FrameParts.JTextFieldSet(100,440,100,20,"",11,0);			//JISCD5桁
		final JTextField TB_PTMSCD			= B100_FrameParts.JTextFieldSet(100,465,100,20,"",11,0);			//基幹SYS発着CD
		final JTextField TB_EntryDate		= B100_FrameParts.JTextFieldSet(100,490,250,20,"",11,0);			//データ登録日時
		final JTextField TB_UpdateDate		= B100_FrameParts.JTextFieldSet(100,515,250,20,"",11,0);			//データ更新日時
		final JTextField TB_EntryUser		= B100_FrameParts.JTextFieldSet(100,540,250,20,"",11,0);			//登録者コード
		final JTextField TB_UpdateUser		= B100_FrameParts.JTextFieldSet(100,565,250,20,"",11,0);			//更新者コード
		final JTextField TB_FirstClient		= B100_FrameParts.JTextFieldSet(100,590,250,20,"",11,0);			//登録した荷主
		final JTextField TB_LastClient		= B100_FrameParts.JTextFieldSet(100,615,250,20,"",11,0);			//更新した荷主
		final JComboBox  TB_DelFg			= B100_FrameParts.JComboBoxSet( 100,640,100,20,B100_DefaultVariable.DelList[0],11);	//削除区分
		
		//部署追加ボタン
		JButton AddDepartmentCdBtn = B100_FrameParts.BtnSet(210,65,100,20,"部署追加",11);
		...
		if(!"".equals(DECD) && !"".equals(DepartmentCd)) {
			...
			if(0<DeliveryMstRt.length) {
				TB_DECD.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColDECD]);
				TB_DepartmentCd.setText(	""+DeliveryMstRt[0][M100_DeliveryMstRt.ColDepartmentCd]);
				TB_DEName01.setText(		""+DeliveryMstRt[0][M100_DeliveryMstRt.ColDEName01]);
				TB_DEName02.setText(		""+DeliveryMstRt[0][M100_DeliveryMstRt.ColDEName02]);
				TB_DEName03.setText(		""+DeliveryMstRt[0][M100_DeliveryMstRt.ColDEName03]);
				TB_Post.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColPost]);
				TB_Add01.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColAdd01]);
				TB_Add02.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColAdd02]);
				TB_Add03.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColAdd03]);
				TB_Tel.setText(				""+DeliveryMstRt[0][M100_DeliveryMstRt.ColTel]);
				TB_Fax.setText(				""+DeliveryMstRt[0][M100_DeliveryMstRt.ColFax]);
				TB_Mail.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColMail]);
				TB_Com01.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColCom01]);
				TB_Com02.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColCom02]);
				TB_Com03.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColCom03]);
				TB_PrefecturesCd.setText(	""+DeliveryMstRt[0][M100_DeliveryMstRt.ColPrefecturesCd]);
				TB_MunicipalityCd.setText(	""+DeliveryMstRt[0][M100_DeliveryMstRt.ColMunicipalityCd]);
				TB_PTMSCD.setText(			""+DeliveryMstRt[0][M100_DeliveryMstRt.ColPTMSCD]);
				TB_EntryDate.setText(		""+DeliveryMstRt[0][M100_DeliveryMstRt.ColEntryDate]);
				TB_UpdateDate.setText(		""+DeliveryMstRt[0][M100_DeliveryMstRt.ColUpdateDate]);
				TB_EntryUser.setText(		""+DeliveryMstRt[0][M100_DeliveryMstRt.ColEntryUser]);
				TB_UpdateUser.setText(		""+DeliveryMstRt[0][M100_DeliveryMstRt.ColUpdateUser]);
				TB_FirstClient.setText(		"("+DeliveryMstRt[0][22]+")"+DeliveryMstRt[0][M100_DeliveryMstRt.ColFirstClientName]);
				TB_LastClient.setText(		"("+DeliveryMstRt[0][23]+")"+DeliveryMstRt[0][M100_DeliveryMstRt.ColLastClientName]);
				for(int i=0;i<B100_DefaultVariable.DelList[1].length;i++) {
					if(B100_DefaultVariable.DelList[1][i].equals(""+DeliveryMstRt[0][M100_DeliveryMstRt.ColDelFg])) {
						TB_DelFg.setSelectedIndex(i);
					}
				}
				
				//JISコード届け先はメンテナンス禁止
				if("JIS".equals(""+DeliveryMstRt[0][M100_DeliveryMstRt.ColDepartmentCd])) {
		...
		//スクロール用設定
		JScrollPane scpn01 = B100_FrameParts.JScrollPaneSet(10,60,610,300,tb01);
		SameDelivery_fm.add(scpn01);
		
		//重複無視ボタン
		JLabel LB_Set  = B100_FrameParts.JLabelSet(	10,360,150,20,"重複を無視して" ,11,0);
		SameDelivery_fm.add(LB_Set);
		JButton SetBtn = B100_FrameParts.BtnSet(		10,380,100,20,"新規登録",11);
		SameDelivery_fm.add(SetBtn);
		
		//登録やり直しボタン
		JLabel LB_MstEntry  = B100_FrameParts.JLabelSet(	160,360,150,20,"チェックした届先で" ,11,0);
		SameDelivery_fm.add(LB_MstEntry);
		JButton MstEntryBtn = B100_FrameParts.BtnSet(		160,380,100,20,"登録やり直し",11);
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(KickFg) {
						...
						main_fm.dispose();
						WM100_DeliveryMst_01_RenewAndCreate.DeliveryMstRenewAndCreate(0, 0,GetDECD,GetDepartmentCd);
					}
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					GetPrefecturesCd	= B100_TextControl.Trim(GetPrefecturesCd);
					GetMunicipalityCd	= B100_TextControl.Trim(GetMunicipalityCd);
					...
					GetPrefecturesCd	= B100_TextControl.num_only_String(GetPrefecturesCd);
					GetMunicipalityCd	= B100_TextControl.num_only_String(GetMunicipalityCd);
					...
					if(!"".equals(GetDEName01)) {
						if(!"".equals(GetDECD)) {
							...
							if(0==SameDelivery.length) {
								String[] DeliveryCdGet = M100_DeliveryMstRt.DeliveryCdGet(1);
								...
								for(int i=0;i<SameDelivery.length;i++) {
									...
									SetOb[0] = false;
									SetOb[ 1] = ""+SameDelivery[i][M100_DeliveryMstRt.ColDECD];			//届先CD
									SetOb[ 2] = ""+SameDelivery[i][M100_DeliveryMstRt.ColDepartmentCd];	//部署CD
	...
	private static void DeliveryEntry(
		...
		if(!"".equals(GetPost)) {
			...
			Object[][] PostRt = M100_PostMstRt.PostRt(SearchPOST, SearchAddT, AllSearch, PostPerfectMatch);
			if(0<PostRt.length) {
