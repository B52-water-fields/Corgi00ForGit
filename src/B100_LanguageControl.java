...
public class B100_LanguageControl{
	...
	public static void DefaultVariableControl() {
		...
		//JP : 未指定 / 未回収 / 回収済 / 返送済 / 回収不要
		//EN : Unspecified / Not Collected / Collected / Returned / Collection Not Required
		//ZH : 未指定 / 未回收 / 已回收 / 已返还 / 无需回收
		...
		//JP : 未指定 / 未請求 / 請求済 / 対象外
		//EN : Unspecified / Not Invoiced / Invoiced / Not Applicable
		//ZH : 未指定 / 未开票 / 已开票 / 不适用
		...
		//JP : 未指定 / 未確定 / 確定済
		//EN : Unspecified / Unconfirmed / Confirmed
		//ZH : 未指定 / 未确定 / 已确定
		...
		//JP : 未指定 / 一般 / 代引
		//EN : Unspecified / Standard / Cash on Delivery
		//ZH : 未指定 / 普通 / 货到付款
		...
		//JP : 未指定 / バラ / カートン / ケース / パレット
		//EN : Unspecified / Each / Carton / Case / Pallet
		//ZH : 未指定 / 单品 / 纸箱 / 箱 / 托盘
