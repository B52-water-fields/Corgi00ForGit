...
public class WM100CautionMstSearch{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtCautionCd) && !"".equals(TgtDECD)) {
						...
						WM100CautionMstRenewAndCreate.CautionMstRenewAndCreate(0,0,TgtCautionCd,TgtDECD,TgtDepartmentCd);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WM100CautionMstRenewAndCreate.CautionMstRenewAndCreate(0,0,"","","");
					RenewFg = true;
				}
			}
		});
