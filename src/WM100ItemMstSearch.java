...
public class WM100ItemMstSearch{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.dispose();
						WM100ItemMstExcelEntry.ItemMstExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtClgpCd) && !"".equals(TgtItemCd)) {
						...
						WM100ItemMstRenewAndCreate.ItemMstRenewAndCreate(0,0,TgtClgpCd,TgtItemCd);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					WM100ItemMstRenewAndCreate.ItemMstRenewAndCreate(0,0,"","");
					RenewFg = true;
				}
			}
		});
