...
public class WM100_PostMst_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	public static void PostMstRenewAndCreate(int x,int y,String TgtPost) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,500,250,"Corgi00郵便番号登録・修正　WM100_PostMst_01_RenewAndCreate","");
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				...
				GetMuniciparytyCd = B100_TextControl.num_only_String(GetMuniciparytyCd);
				...
				if(KickFg) {
					...
					judg_data[0][0] = B100_TextControl.Trim(GetPost);	//郵便番号
					
					entry_data[0][0] = B100_TextControl.Trim(GetPost);			//郵便番号
					entry_data[0][1] = B100_TextControl.Trim(GetPrefecturs);		//県
					entry_data[0][2] = B100_TextControl.Trim(GetMunic01);			//市区町村
					entry_data[0][3] = B100_TextControl.Trim(GetMunic02);			//町丁目
					entry_data[0][4] = B100_TextControl.Trim(GetMuniciparytyCd);	//市区町村CD
