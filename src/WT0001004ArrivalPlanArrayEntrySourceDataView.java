...
public class WT0001004ArrivalPlanArrayEntrySourceDataView{
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				...
				if(null!=ErrMsg && 0<ErrMsg.size()) {
					...
					main_fm.dispose();
					WT0001005ArrivalPlanArrayEntrySetDataView.ArrivalPlanArrayEntrySetDataView(SetX+10,SetY+10,SetObRt);
				}
			}
		});
	...
	public static ArrayList<String> ErrCheck(Object[][] CheckOb){
		...
		Object[][] ItemComversion = WMTools000100ItemComversion.ItemComversion(A00000Main.ClCd,ClItemCd);
	...
	private static Object[][] SetObRt(Object[][]CheckOb){
		...
		Object[][] SetOb = new Object[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.RtSetDataDefinition().length];
		EntryCount = 0;
		...
		for(int i=0;i<CheckOb.length;i++) {
			if(!"".equals((String)CheckOb[i][ColClItemCd])&&0<(int)CheckOb[i][ColPlanQty]) {
				...
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdClWh]			= (String)CheckOb[i][ColClWh];		//ヘッダ担当倉庫
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdClCd]			= (String)CheckOb[i][ColClCd];		//ヘッダ荷主CD
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdArrNo]		= "";	//ヘッダ入荷予定NO
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdClArrNo]		= (String)CheckOb[i][ColClArrNo];	//ヘッダ荷主予定番号
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdPlanDate]		= (String)CheckOb[i][ColPlanDate];	//ヘッダ入荷予定日
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdActualDate]	= "";	//ヘッダ入荷実績日
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpCd]			= (String)CheckOb[i][ColSPCd];		//ヘッダ仕入先CD"}
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpName01]		= "";	//ヘッダ仕入先名01
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpName02]		= "";	//ヘッダ仕入先名02
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpName03]		= "";	//ヘッダ仕入先名03
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpPost]		= "";	//ヘッダ仕入先郵便
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpAdd01]		= "";	//ヘッダ仕入先住所01
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpAdd02]		= "";	//ヘッダ仕入先住所02
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpAdd03]		= "";	//ヘッダ仕入先住所03
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdSpTel]		= "";	//ヘッダ仕入先電話
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdArCom01]		= (String)CheckOb[i][ColHdCom01];	//ヘッダコメント1
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdArCom02]		= (String)CheckOb[i][ColHdCom02];	//ヘッダコメント2
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdArCom03]		= (String)CheckOb[i][ColHdCom03];	//ヘッダコメント3
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetHdFixFg]		= 0;	//ヘッダ状況
				
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetMsNo]			= "";		//明細番号
				
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetClItemCd]		= (String)CheckOb[i][ColClItemCd];	//荷主商品コード
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetJanCd]			= "";		//ソースマーク_BCD
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetItemMdNo]		= "";		//商品型番
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetItemName]		= "";		//商品名
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetlot]				= (String)CheckOb[i][ColLot];	//ロット
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetExpDate]		= (String)CheckOb[i][ColExpDate];	//消費期限
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetPlanQty]		= (int)CheckOb[i][ColPlanQty];	//予定数量
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetActualQty]		= (int)0;	//実績数
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetActualDate]		= "";		//入荷日
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetCom01]			= (String)CheckOb[i][ColMsCom01];		//コメント1
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetCom02]			= (String)CheckOb[i][ColMsCom02];		//コメント2
				SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColUnitType]			= 0;		//荷姿タイプ
				...
				for(int i01=0;i01<ItemComversion.length;i01++) {
					if(((String)CheckOb[i][ColClItemCd]).equals((String)ItemComversion[i01][WMTools000100ItemComversion.ColClIemCd])) {
						if(!"".equals((String)ItemComversion[i01][WMTools000100ItemComversion.ColItemCd])) {
							SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetItemCd]	= (String)ItemComversion[i01][WMTools000100ItemComversion.ColItemCd];		//商品コード
							SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColUnitType]	= (int)ItemComversion[i01][WMTools000100ItemComversion.ColPackingType];	//荷姿タイプ
							
							TgtItemCd.add((String)SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetItemCd]);
						}
						i01=ItemComversion.length+1;
					}
				}
			...
			if(!"".equals((String)CheckOb[i][ColClItemCd])&&0<(int)CheckOb[i][ColPlanQty]) {
				...
				for(int i01=0;i01<ItemMstRt.length;i01++) {
					if(((String)SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetItemCd]).equals((String)ItemMstRt[i01][M00070ItemMstRt.ColItemCd])) {
						...
						switch((int)SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColUnitType]	) {
							case 0:			//バラ
								break;
							case 1:			//カートン
								SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetPlanQty]	= GetCtQty*(int)SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetPlanQty];	//予定数量
								break;
							case 2:			//ケース
								SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetPlanQty]	= GetCsQty*(int)SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetPlanQty];	//予定数量
								break;
							case 3:			//パレット
								SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetPlanQty]	= GetPlQty*(int)SetOb[EntryCount][WT0001005ArrivalPlanArrayEntrySetDataView.ColSetPlanQty];	//予定数量
								break;
							default:
								break;
						}
