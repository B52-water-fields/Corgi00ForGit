...
public class WM100CarMstSearch{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtCar)) {
						...
						main_fm.dispose();
						WM100CarMstRenewAndCreate.CarMstRenewAndCreate(0,0,TgtWhCd,TgtShippingCompanyCd,TgtCar);
					}
					RenewFg = true;
				}
			}
		...
		CreateBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					main_fm.setVisible(false);
					main_fm.dispose();
					WM100CarMstRenewAndCreate.CarMstRenewAndCreate(0,0,"","","");
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100CarMstExcelEntry.CarMstExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
