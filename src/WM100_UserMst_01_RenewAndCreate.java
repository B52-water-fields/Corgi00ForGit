...
public class WM100_UserMst_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	...
	public static void UserMstRenewAndCreate(int x,int y,String TgtWhCd,String TgtShippingCompanyCd,String TgtUserCd) {
		RenewFg = false;
		SearchClList = B100_DefaultVariable.SearchClList;
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,500,800,"Corgi00ユーザー登録・修正　WM100_UserMst_01_RenewAndCreate","");
		...
		JButton Check_btn = B100_FrameParts.BtnSet(B100_FrameParts.Width-140, 90,100,20,"CD確認",11);	//ユーザーCDの存在確認
		main_fm.add(Check_btn);
		
		JButton CdRenew_btn = B100_FrameParts.BtnSet(B100_FrameParts.Width-140,115,100,20,"CD修正Mode",11);		//ユーザーCDの存在確認
		main_fm.add(CdRenew_btn);
		
		JButton NewCreate_btn = B100_FrameParts.BtnSet(B100_FrameParts.Width-140,140,100,20,"新規登録Mode",10);	//新規登録モードへ
		main_fm.add(NewCreate_btn);
		
		Object[][] RtUserMstRt	= M100_UserMstRt.RtUserMstRt();
		
		JLabel LB_WHCD				= B100_FrameParts.JLabelSet(  0, 40,100,20,RtUserMstRt[M100_UserMstRt.ColWHCD][3]					+	":"	,	11,1);
		JLabel LB_ShippingCompanyCd	= B100_FrameParts.JLabelSet(  0, 65,100,20,RtUserMstRt[M100_UserMstRt.ColShippingCompanyCd][3]	+	":"	,	11,1);
		JLabel LB_UserCd			= B100_FrameParts.JLabelSet(  0, 90,100,20,RtUserMstRt[M100_UserMstRt.ColUserCd][3]				+	":"	,	11,1);
		JLabel LB_MainClient		= B100_FrameParts.JLabelSet(  0,115,100,20,RtUserMstRt[M100_UserMstRt.ColMainClient][3]			+	":"	,	11,1);
		JLabel LB_AuthorityFG		= B100_FrameParts.JLabelSet(  0,140,100,20,RtUserMstRt[M100_UserMstRt.ColAuthorityFG][3]			+	":"	,	11,1);
		JLabel LB_PassWord			= B100_FrameParts.JLabelSet(  0,165,100,20,RtUserMstRt[M100_UserMstRt.ColPassWord][3]			+	":"	,	11,1);
		JLabel LB_UserName01		= B100_FrameParts.JLabelSet(  0,190,100,20,RtUserMstRt[M100_UserMstRt.ColUserName01][3]			+	":"	,	11,1);
		JLabel LB_UserName02		= B100_FrameParts.JLabelSet(  0,215,100,20,RtUserMstRt[M100_UserMstRt.ColUserName02][3]			+	":"	,	11,1);
		JLabel LB_UserName03		= B100_FrameParts.JLabelSet(  0,240,100,20,RtUserMstRt[M100_UserMstRt.ColUserName03][3]			+	":"	,	11,1);
		JLabel LB_CarCd				= B100_FrameParts.JLabelSet(  0,265,100,20,RtUserMstRt[M100_UserMstRt.ColCarCd][3]				+	":"	,	11,1);
		JLabel LB_Post				= B100_FrameParts.JLabelSet(  0,290,100,20,RtUserMstRt[M100_UserMstRt.ColPost][3]					+	":"	,	11,1);
		JLabel LB_Add01				= B100_FrameParts.JLabelSet(  0,315,100,20,RtUserMstRt[M100_UserMstRt.ColAdd01][3]				+	":"	,	11,1);
		JLabel LB_Add02				= B100_FrameParts.JLabelSet(  0,340,100,20,RtUserMstRt[M100_UserMstRt.ColAdd02][3]				+	":"	,	11,1);
		JLabel LB_Add03				= B100_FrameParts.JLabelSet(  0,365,100,20,RtUserMstRt[M100_UserMstRt.ColAdd03][3]				+	":"	,	11,1);
		JLabel LB_Tel				= B100_FrameParts.JLabelSet(  0,390,100,20,RtUserMstRt[M100_UserMstRt.ColTel][3]					+	":"	,	11,1);
		JLabel LB_Fax				= B100_FrameParts.JLabelSet(  0,415,100,20,RtUserMstRt[M100_UserMstRt.ColFax][3]					+	":"	,	11,1);
		JLabel LB_Mail				= B100_FrameParts.JLabelSet(  0,440,100,20,RtUserMstRt[M100_UserMstRt.ColMail][3]					+	":"	,	11,1);
		JLabel LB_Com01				= B100_FrameParts.JLabelSet(  0,465,100,20,RtUserMstRt[M100_UserMstRt.ColCom01][3]				+	":"	,	11,1);
		JLabel LB_Com02				= B100_FrameParts.JLabelSet(  0,490,100,20,RtUserMstRt[M100_UserMstRt.ColCom02][3]				+	":"	,	11,1);
		JLabel LB_Com03				= B100_FrameParts.JLabelSet(  0,515,100,20,RtUserMstRt[M100_UserMstRt.ColCom03][3]				+	":"	,	11,1);
		JLabel LB_EntryDate			= B100_FrameParts.JLabelSet(  0,540,100,20,RtUserMstRt[M100_UserMstRt.ColEntryDate][3]			+	":"	,	11,1);
		JLabel LB_UpdateDate		= B100_FrameParts.JLabelSet(  0,565,100,20,RtUserMstRt[M100_UserMstRt.ColUpdateDate][3]			+	":"	,	11,1);
		JLabel LB_EntryUser			= B100_FrameParts.JLabelSet(  0,590,100,20,RtUserMstRt[M100_UserMstRt.ColEntryUser][3]			+	":"	,	11,1);
		JLabel LB_UpdateUser		= B100_FrameParts.JLabelSet(  0,615,100,20,RtUserMstRt[M100_UserMstRt.ColUpdateUser][3]			+	":"	,	11,1);
		JLabel LB_PTMSCD			= B100_FrameParts.JLabelSet(  0,640,100,20,RtUserMstRt[M100_UserMstRt.ColPTMSCD][3]				+	":"	,	11,1);
		JLabel LB_DelFg				= B100_FrameParts.JLabelSet(  0,665,100,20,RtUserMstRt[M100_UserMstRt.ColDelFg][3]				+	":"	,	11,1);
		...
		final JTextField TB_UserCd				= B100_FrameParts.JTextFieldSet(100, 90,100,20,"",11,0);	//ユーザーCD
		final JComboBox  TB_MainClient			= B100_FrameParts.JComboBoxSet( 100,115,250,20,SearchClList[0],	11);								//主要担当荷主
		final JComboBox  TB_AuthorityFG			= B100_FrameParts.JComboBoxSet( 100,140,250,20,B100_DefaultVariable.AuthorityFG[0],	11);			//権限区分
		final JTextField TB_PassWord			= B100_FrameParts.JTextFieldSet(100,165,100,20,"",11,0);	//パスワード
		final JTextField TB_UserName01			= B100_FrameParts.JTextFieldSet(100,190,250,20,"",11,0);	//ユーザー名1
		final JTextField TB_UserName02			= B100_FrameParts.JTextFieldSet(100,215,250,20,"",11,0);	//ユーザー名2
		final JTextField TB_UserName03			= B100_FrameParts.JTextFieldSet(100,240,250,20,"",11,0);	//ユーザー名3
		final JTextField TB_CarCd				= B100_FrameParts.JTextFieldSet(100,265,100,20,"",11,0);	//標準車輛
		final JTextField TB_Post				= B100_FrameParts.JTextFieldSet(100,290,100,20,"",11,0);	//郵便番号
		final JTextField TB_Add01				= B100_FrameParts.JTextFieldSet(100,315,250,20,"",11,0);	//住所1
		final JTextField TB_Add02				= B100_FrameParts.JTextFieldSet(100,340,250,20,"",11,0);	//住所2
		final JTextField TB_Add03				= B100_FrameParts.JTextFieldSet(100,365,250,20,"",11,0);	//住所3
		final JTextField TB_Tel					= B100_FrameParts.JTextFieldSet(100,390,100,20,"",11,0);	//Tel
		final JTextField TB_Fax					= B100_FrameParts.JTextFieldSet(100,415,100,20,"",11,0);	//FAX
		final JTextField TB_Mail				= B100_FrameParts.JTextFieldSet(100,440,100,20,"",11,0);	//Mail
		final JTextField TB_Com01				= B100_FrameParts.JTextFieldSet(100,465,250,20,"",11,0);	//コメント1
		final JTextField TB_Com02				= B100_FrameParts.JTextFieldSet(100,490,250,20,"",11,0);	//コメント2
		final JTextField TB_Com03				= B100_FrameParts.JTextFieldSet(100,515,250,20,"",11,0);	//コメント3
		final JTextField TB_EntryDate			= B100_FrameParts.JTextFieldSet(100,540,250,20,"",11,0);	//データ登録日時
		final JTextField TB_UpdateDate			= B100_FrameParts.JTextFieldSet(100,565,250,20,"",11,0);	//データ更新日時
		final JTextField TB_EntryUser			= B100_FrameParts.JTextFieldSet(100,590,250,20,"",11,0);	//登録者コード
		final JTextField TB_UpdateUser			= B100_FrameParts.JTextFieldSet(100,615,250,20,"",11,0);	//更新者コード
		final JTextField TB_PTMSCD				= B100_FrameParts.JTextFieldSet(100,640,100,20,"",11,0);	//基幹SYSCD
		final JComboBox  TB_DelFg				= B100_FrameParts.JComboBoxSet( 100,665,150,20,B100_DefaultVariable.DelList[0],	11);				//削除区分
		...
		for(int i=0;i<B100_DefaultVariable.WhList[1].length;i++){
			if((""+B100_DefaultVariable.WhList[1][i]).equals(""+A00000_Main.ClWh)){
				TB_WHCD.setSelectedIndex(i);
			}
		}
		
		for(int i=0;i<B100_DefaultVariable.ShippingCompanyList[1].length;i++){
			if((""+B100_DefaultVariable.ShippingCompanyList[1][i]).equals(""+A00000_Main.LoginUserCompany)){
				TB_ShippingCompanyCd.setSelectedIndex(i);
			}
		}
		
		//主要担当荷主を選択中の倉庫配下の荷主だけにする
		String GetWHCD	= ""+B100_DefaultVariable.WhList[1][TB_WHCD.getSelectedIndex()];
		...
		if(0<ClMstRt.length) {
			...
			for(int i=0;i<ClMstRt.length;i++) {
				SearchClList[0][i+1] = "" + ClMstRt[i][M100_ClMstRt.Colcl_cd] + ":" + ClMstRt[i][M100_ClMstRt.ColCLName01];
				SearchClList[1][i+1] = "" + ClMstRt[i][M100_ClMstRt.Colcl_cd];
				SearchClList[2][i+1] = "" + ClMstRt[i][M100_ClMstRt.ColCLName01];
		...
		if(!"".equals(TgtWhCd)&&!"".equals(TgtShippingCompanyCd)&&!"".equals(TgtUserCd)) {
			...
			if(0<UserMstRt.length) {
				...
				boolean KickFg = true;
				if("9".equals(""+UserMstRt[0][M100_UserMstRt.ColAuthorityFG])) {
					KickFg = false;
				}
				...
				if(KickFg) {
					for(int i=0;i<B100_DefaultVariable.WhList[1].length;i++){
						if((""+B100_DefaultVariable.WhList[1][i]).equals(""+UserMstRt[0][M100_UserMstRt.ColWHCD])){
							TB_WHCD.setSelectedIndex(i);
						}
					}
					
					for(int i=0;i<B100_DefaultVariable.ShippingCompanyList[1].length;i++){
						if((""+B100_DefaultVariable.ShippingCompanyList[1][i]).equals(""+UserMstRt[0][M100_UserMstRt.ColShippingCompanyCd])){
							TB_ShippingCompanyCd.setSelectedIndex(i);
						}
					}
					
					//主要担当荷主を選択中の倉庫配下の荷主だけにする
					GetWHCD	= ""+B100_DefaultVariable.WhList[1][TB_WHCD.getSelectedIndex()];
					...
					for(int i=0;i<SearchClList[1].length;i++){
						if((""+SearchClList[1][i]).equals(""+UserMstRt[0][M100_UserMstRt.ColMainClient])){
							TB_MainClient.setSelectedIndex(i);
						}
					}
					
					for(int i=0;i<B100_DefaultVariable.AuthorityFG[1].length;i++){
						if((""+B100_DefaultVariable.AuthorityFG[1][i]).equals(""+UserMstRt[0][M100_UserMstRt.ColAuthorityFG])){
							TB_AuthorityFG.setSelectedIndex(i);
						}
					}
					
					for(int i=0;i<B100_DefaultVariable.DelList[1].length;i++){
						if((""+B100_DefaultVariable.DelList[1][i]).equals(""+UserMstRt[0][M100_UserMstRt.ColDelFg])){
							TB_DelFg.setSelectedIndex(i);
						}
					}
					TB_UserCd.setText(		""+UserMstRt[0][M100_UserMstRt.ColUserCd]);
					TB_PassWord.setText(	""+UserMstRt[0][M100_UserMstRt.ColPassWord]);
					TB_UserName01.setText(	""+UserMstRt[0][M100_UserMstRt.ColUserName01]);
					TB_UserName02.setText(	""+UserMstRt[0][M100_UserMstRt.ColUserName02]);
					TB_UserName03.setText(	""+UserMstRt[0][M100_UserMstRt.ColUserName03]);
					TB_CarCd.setText(		""+UserMstRt[0][M100_UserMstRt.ColCarCd]);
					TB_Post.setText(		""+UserMstRt[0][M100_UserMstRt.ColPost]);
					TB_Add01.setText(		""+UserMstRt[0][M100_UserMstRt.ColAdd01]);
					TB_Add02.setText(		""+UserMstRt[0][M100_UserMstRt.ColAdd02]);
					TB_Add03.setText(		""+UserMstRt[0][M100_UserMstRt.ColAdd03]);
					TB_Tel.setText(			""+UserMstRt[0][M100_UserMstRt.ColTel]);
					TB_Fax.setText(			""+UserMstRt[0][M100_UserMstRt.ColFax]);
					TB_Mail.setText(		""+UserMstRt[0][M100_UserMstRt.ColMail]);
					TB_Com01.setText(		""+UserMstRt[0][M100_UserMstRt.ColCom01]);
					TB_Com02.setText(		""+UserMstRt[0][M100_UserMstRt.ColCom02]);
					TB_Com03.setText(		""+UserMstRt[0][M100_UserMstRt.ColCom03]);
					TB_EntryDate.setText(	""+UserMstRt[0][M100_UserMstRt.ColEntryDate]);
					TB_UpdateDate.setText(	""+UserMstRt[0][M100_UserMstRt.ColUpdateDate]);
					TB_EntryUser.setText(	""+UserMstRt[0][M100_UserMstRt.ColEntryUser]);
					TB_UpdateUser.setText(	""+UserMstRt[0][M100_UserMstRt.ColUpdateUser]);
					TB_PTMSCD.setText(		""+UserMstRt[0][M100_UserMstRt.ColPTMSCD]);
		...
		Check_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					String GetShippingCompanyCd	= ""+B100_DefaultVariable.ShippingCompanyList[1][TB_ShippingCompanyCd.getSelectedIndex()];	//運送会社CD
					...
					GetShippingCompanyCd	= B100_TextControl.Trim(GetShippingCompanyCd);
					GetUserCd				= B100_TextControl.Trim(GetUserCd);
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					String GetAuthorityFG		= ""+B100_DefaultVariable.AuthorityFG[1][TB_AuthorityFG.getSelectedIndex()];					//権限区分
					String GetDelFg				= ""+B100_DefaultVariable.DelList[1][TB_DelFg.getSelectedIndex()];							//削除区分
					...
					GetWHCD					= B100_TextControl.Trim(GetWHCD);
					GetShippingCompanyCd	= B100_TextControl.Trim(GetShippingCompanyCd);
					GetMainClient			= B100_TextControl.Trim(GetMainClient);
					GetAuthorityFG			= B100_TextControl.Trim(GetAuthorityFG);
					GetDelFg				= B100_TextControl.Trim(GetDelFg);
					GetUserCd				= B100_TextControl.Trim(GetUserCd);
					GetPassWord				= B100_TextControl.Trim(GetPassWord);
					GetUserName01			= B100_TextControl.Trim(GetUserName01);
					GetUserName02			= B100_TextControl.Trim(GetUserName02);
					GetUserName03			= B100_TextControl.Trim(GetUserName03);
					GetCarCd				= B100_TextControl.Trim(GetCarCd);
					...
					GetEntryDate			= B100_TextControl.Trim(GetEntryDate);
					GetUpdateDate			= B100_TextControl.Trim(GetUpdateDate);
					GetEntryUser			= B100_TextControl.Trim(GetEntryUser);
					GetUpdateUser			= B100_TextControl.Trim(GetUpdateUser);
					...
					GetAuthorityFG	= B100_TextControl.num_only_String(GetAuthorityFG);	if("".equals(GetAuthorityFG)) {GetAuthorityFG   = "0";}
					GetDelFg		= B100_TextControl.num_only_String(GetDelFg);	if("".equals(GetDelFg)) {GetDelFg = "0";}
					
					GetUserCd		= B100_TextControl.only1byte_String(GetUserCd);
