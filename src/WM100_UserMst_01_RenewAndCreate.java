...
public class WM100_UserMst_01_RenewAndCreate{
	...
	public static void UserMstRenewAndCreate(int x,int y,String TgtWhCd,String TgtShippingCompanyCd,String TgtUserCd) {
		...
		JLabel LB_UserCd			= B100_FrameParts.JLabelSet(  0, 90,100,20,"ユーザーCD:",		11,1);
		JLabel LB_MainClient		= B100_FrameParts.JLabelSet(  0,115,100,20,"主要担当荷主:",	11,1);
		JLabel LB_AuthorityFG		= B100_FrameParts.JLabelSet(  0,140,100,20,"権限区分:",		11,1);
		JLabel LB_PassWord			= B100_FrameParts.JLabelSet(  0,165,100,20,"パスワード:",		11,1);
		JLabel LB_UserName01		= B100_FrameParts.JLabelSet(  0,190,100,20,"ユーザー名1:",	11,1);
		JLabel LB_UserName02		= B100_FrameParts.JLabelSet(  0,215,100,20,"ユーザー名2:",	11,1);
		JLabel LB_UserName03		= B100_FrameParts.JLabelSet(  0,240,100,20,"ユーザー名3:",	11,1);
		JLabel LB_CarCd				= B100_FrameParts.JLabelSet(  0,265,100,20,"標準車輛:",		11,1);
		JLabel LB_Post				= B100_FrameParts.JLabelSet(  0,290,100,20,"郵便番号:",		11,1);
		JLabel LB_Add01				= B100_FrameParts.JLabelSet(  0,315,100,20,"住所1:",			11,1);
		JLabel LB_Add02				= B100_FrameParts.JLabelSet(  0,340,100,20,"住所2:",			11,1);
		JLabel LB_Add03				= B100_FrameParts.JLabelSet(  0,365,100,20,"住所3:",			11,1);
		JLabel LB_Tel				= B100_FrameParts.JLabelSet(  0,390,100,20,"Tel:",			11,1);
		JLabel LB_Fax				= B100_FrameParts.JLabelSet(  0,415,100,20,"FAX:",			11,1);
		JLabel LB_Mail				= B100_FrameParts.JLabelSet(  0,440,100,20,"Mail:",			11,1);
		JLabel LB_Com01				= B100_FrameParts.JLabelSet(  0,465,100,20,"コメント1:",		11,1);
		JLabel LB_Com02				= B100_FrameParts.JLabelSet(  0,490,100,20,"コメント2:",		11,1);
		JLabel LB_Com03				= B100_FrameParts.JLabelSet(  0,515,100,20,"コメント3:",		11,1);
		JLabel LB_EntryDate			= B100_FrameParts.JLabelSet(  0,540,100,20,"データ登録日時:",	11,1);
		JLabel LB_UpdateDate		= B100_FrameParts.JLabelSet(  0,565,100,20,"データ更新日時:",	11,1);
		JLabel LB_EntryUser			= B100_FrameParts.JLabelSet(  0,590,100,20,"登録者コード:",	11,1);
		JLabel LB_UpdateUser		= B100_FrameParts.JLabelSet(  0,615,100,20,"更新者コード:",	11,1);
		JLabel LB_PTMSCD			= B100_FrameParts.JLabelSet(  0,640,100,20,"基幹SYSCD:",		11,1);
		JLabel LB_DelFg				= B100_FrameParts.JLabelSet(  0,665,100,20,"削除区分:",		11,1);
