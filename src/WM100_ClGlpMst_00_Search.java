...
public class WM100_ClGlpMst_00_Search{
	...
	public static void ClGlpMstSearch(int x,int y) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,780,750,"Corgi00荷主グループ検索　WM100_ClGlpMst_00_Search","");
		...
		JLabel LB2_SearchClGpCD  = B100_FrameParts.JLabelSet(					200, 25,100,20,B100_DefaultVariable.SearchExact	,11,0);
		JLabel LB2_SearchCLGpName  = B100_FrameParts.JLabelSet(	 			250, 50,100,20,B100_DefaultVariable.SearchPartial	,11,0);
		...
		JLabel LB2_SearchMail  = B100_FrameParts.JLabelSet(		 			600, 75,100,20,B100_DefaultVariable.SearchPartial	,11,0);
