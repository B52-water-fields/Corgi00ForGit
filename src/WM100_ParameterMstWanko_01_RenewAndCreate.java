...
public class WM100_ParameterMstWanko_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	public static void ParameterMstWankoRenewAndCreate(int x,int y,String TgtWhCd,String TgtClCd,String TgtParaCd,String TgtParaCdSeq) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,700,650,"Corgi00荷主パラメータ登録・修正　WM100_ParameterMstWanko_01_RenewAndCreate","");
		...
		for(int i=0;i<B100_DefaultVariable.ClList[1].length;i++) {
			if(B100_DefaultVariable.ClList[1][i].equals(A00000_Main.ClCd)) {
		...
		if(!"".equals(TgtParaCd) && !"".equals(TgtParaCdSeq)) {
			...
			if(1==ParameterMstRtWANKO.length) {
				for(int i=0;i<B100_DefaultVariable.ClList[1].length;i++) {
					if(B100_DefaultVariable.ClList[1][i].equals((String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColClCd])) {
						TB_ClCd.setSelectedIndex(i);
					}
				}
				for(int i=0;i<B100_DefaultVariable.WhList[1].length;i++) {
					if(B100_DefaultVariable.WhList[1][i].equals((String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColClWh])) {
						TB_WhCd.setSelectedIndex(i);
					}
				}
				TB_ParaCd.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaCd]);			//パラメータコード
				TB_ParaCdSeq.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaCdSeq]);		//ナンバリング
				TB_ParaName.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaName]);		//パラメータ名
				TB_ParaTxt01.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt01]);	//パラメータテキスト項目01
				TB_ParaTxt02.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt02]);	//パラメータテキスト項目02
				TB_ParaTxt03.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt03]);	//パラメータテキスト項目03
				TB_ParaTxt04.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt04]);	//パラメータテキスト項目04
				TB_ParaTxt05.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt05]);	//パラメータテキスト項目05
				TB_ParaTxt06.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt06]);	//パラメータテキスト項目06
				TB_ParaTxt07.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt07]);	//パラメータテキスト項目07
				TB_ParaTxt08.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt08]);	//パラメータテキスト項目08
				TB_ParaTxt09.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt09]);	//パラメータテキスト項目09
				TB_ParaTxt10.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaTxt10]);	//パラメータテキスト項目10
				TB_ParaInt01.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt01]);		//パラメータ数値項目01
				TB_ParaInt02.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt02]);		//パラメータ数値項目02
				TB_ParaInt03.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt03]);		//パラメータ数値項目03
				TB_ParaInt04.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt04]);		//パラメータ数値項目04
				TB_ParaInt05.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt05]);		//パラメータ数値項目05
				TB_ParaInt06.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt06]);		//パラメータ数値項目06
				TB_ParaInt07.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt07]);		//パラメータ数値項目07
				TB_ParaInt08.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt08]);		//パラメータ数値項目08
				TB_ParaInt09.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt09]);		//パラメータ数値項目09
				TB_ParaInt10.setText(""+(int)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColParaInt10]);		//パラメータ数値項目10
				TB_EntryDate.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColEntryDate]);	//登録日
				TB_UpdateDate.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColUpdateDate]);	//更新日
				TB_EntryUser.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColEntryUser]);	//登録者
				TB_UpdateUser.setText(""+(String)ParameterMstRtWANKO[0][M100_ParameterMstWankoRt.ColUpdateUser]);	//更新者
			}
		}
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				String GetClWh		= B100_DefaultVariable.WhList[1][TB_WhCd.getSelectedIndex()];	//担当倉庫コード
