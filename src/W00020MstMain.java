...
public class W00020MstMain{
	...
	public static void MstMain(int x,int y) {
		...
		final JFrame main_fm = B00110FrameParts.FrameCreate(x,y,700,750,"Corgi00マスタメニュー","");
		
		JLabel userinfo = B00110FrameParts.UserInfo();
		JButton exit_btn = B00110FrameParts.ExitBtn();
		
		//荷主設定パネル
		JPanel PN_AboutClient = B00110FrameParts.JPanelSet(10,40,670,235,"White");
		JLabel LB_AboutClient = B00110FrameParts.JLabelSet(10,0,150,20,"荷主毎設定",11,0);
		PN_AboutClient.add(LB_AboutClient);
		
		//配車設定パネル
		JPanel PN_AboutHaisya = B00110FrameParts.JPanelSet(10,280,670,175,"White");
		JLabel LB_AboutHaisya = B00110FrameParts.JLabelSet(10,0,150,20,"配車設定",11,0);
		PN_AboutHaisya.add(LB_AboutHaisya);
		
		//全体設定パネル
		JPanel PN_AboutALL = B00110FrameParts.JPanelSet(10,460,670,200,"White");
