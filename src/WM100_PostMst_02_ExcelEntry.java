...
public class WM100_PostMst_02_ExcelEntry{
	...
	public static void PostMstExcelEntry(int x,int y,String TgtFilePath) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,600,200,"Corgi00郵便番号登録（エクセル）　WM100_PostMst_02_ExcelEntry","");
	...
	public static void PostMstExcelEntryMain(int x,int y,String TgtFilePath,String SheetName) {
		...
		final JFrame main_fm = B100_FrameParts.FrameCreate(x,y,750,750,"Corgi00郵便番号登録（エクセル）　WM100_PostMst_02_ExcelEntry","");
		JLabel userinfo = B100_FrameParts.UserInfo();
		JButton exit_btn = B100_FrameParts.ExitBtn();
		JButton entry_btn = B100_FrameParts.EntryBtn();
