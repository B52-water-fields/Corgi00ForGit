...
public class WM100_SupplierMst_01_RenewAndCreate{
	...
	public static void SupplierMstRenewAndCreate(int x,int y,String TgtClCd,String TgtWhCd,String TgSPCd) {
		...
		JLabel LB_SPAdd03			= B100_FrameParts.JLabelSet(   0,275,130,20,"仕入先住所3:"		,10,1);
		JLabel LB_SPTel				= B100_FrameParts.JLabelSet(   0,300,130,20,"仕入先電話:"			,10,1);
		JLabel LB_SPFax				= B100_FrameParts.JLabelSet(   0,325,130,20,"仕入先FAX:"			,10,1);
		JLabel LB_SPMail			= B100_FrameParts.JLabelSet(   0,350,130,20,"仕入先MAIL:"			,10,1);
		JLabel LB_Com01				= B100_FrameParts.JLabelSet(   0,375,130,20,"コメント1:"			,10,1);
		JLabel LB_Com02				= B100_FrameParts.JLabelSet(   0,400,130,20,"コメント2:"			,10,1);
		JLabel LB_Com03				= B100_FrameParts.JLabelSet(   0,425,130,20,"コメント3:"			,10,1);
		JLabel LB_PTMSCDBMN			= B100_FrameParts.JLabelSet(   0,450,130,20,"基幹Sys部門コード:"	,10,1);
		JLabel LB_PTMSCDNINUSHI		= B100_FrameParts.JLabelSet(   0,475,130,20,"基幹Sys荷主コード:"	,10,1);
		JLabel LB_PaySite			= B100_FrameParts.JLabelSet(   0,500,130,20,"支払いサイト:"		,10,1);
		JLabel LB_PayDate			= B100_FrameParts.JLabelSet(   0,525,130,20,"支払日:"				,10,1);
		JLabel LB_ShimeDate			= B100_FrameParts.JLabelSet(   0,550,130,20,"締め日:"				,10,1);
		JLabel LB_EntryDate			= B100_FrameParts.JLabelSet(   0,575,130,20,"登録日:"				,10,1);
		JLabel LB_UpdateDate		= B100_FrameParts.JLabelSet(   0,600,130,20,"更新日:"				,10,1);
		JLabel LB_EntryUser			= B100_FrameParts.JLabelSet( 330,575,130,20,"登録者:"				,10,1);
		JLabel LB_UpdateUser		= B100_FrameParts.JLabelSet( 330,600,130,20,"更新者:"				,10,1);
		JLabel LB_DECD				= B100_FrameParts.JLabelSet(   0,625,130,20,"納品先コード:"		,10,1);
		JLabel LB_DepartmentCd		= B100_FrameParts.JLabelSet(   0,650,130,20,"部署CD:"				,10,1);
		JLabel LB_DEName01			= B100_FrameParts.JLabelSet(   0,675,130,20,"納品先名1:"			,10,1);
