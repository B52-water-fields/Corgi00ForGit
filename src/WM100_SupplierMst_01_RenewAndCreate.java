...
public class WM100_SupplierMst_01_RenewAndCreate{
	static int SetX;
	static int SetY;
	...
	public static void SupplierMstRenewAndCreate(int x,int y,String TgtClCd,String TgtWhCd,String TgSPCd) {
		...
		Object[][] RtSupplierRt	= M100_SupplierRt.RtSupplierRt();
		
		JLabel LB_ClCd				= B100_FrameParts.JLabelSet(   0, 50,130,20,RtSupplierRt[M100_SupplierRt.ColClCd][3]				+":"	,10,1);
		JLabel LB_WhCd				= B100_FrameParts.JLabelSet(   0, 75,130,20,RtSupplierRt[M100_SupplierRt.ColClWh][3]				+":"	,10,1);
		JLabel LB_SPCd				= B100_FrameParts.JLabelSet(   0,100,130,20,RtSupplierRt[M100_SupplierRt.ColSPCd][3]				+":"	,10,1);
		JLabel LB_SPName01			= B100_FrameParts.JLabelSet(   0,125,130,20,RtSupplierRt[M100_SupplierRt.ColSPName01][3]			+":"	,10,1);
		JLabel LB_SPName02			= B100_FrameParts.JLabelSet(   0,150,130,20,RtSupplierRt[M100_SupplierRt.ColSPName02][3]			+":"	,10,1);
		JLabel LB_SPName03			= B100_FrameParts.JLabelSet(   0,175,130,20,RtSupplierRt[M100_SupplierRt.ColSPName03][3]			+":"	,10,1);
		JLabel LB_SPPost			= B100_FrameParts.JLabelSet(   0,200,130,20,RtSupplierRt[M100_SupplierRt.ColSPPost][3]			+":"	,10,1);
		JLabel LB_SPAdd01			= B100_FrameParts.JLabelSet(   0,225,130,20,RtSupplierRt[M100_SupplierRt.ColSPAdd01][3]			+":"	,10,1);
		JLabel LB_SPAdd02			= B100_FrameParts.JLabelSet(   0,250,130,20,RtSupplierRt[M100_SupplierRt.ColSPAdd02][3]			+":"	,10,1);
		JLabel LB_SPAdd03			= B100_FrameParts.JLabelSet(   0,275,130,20,RtSupplierRt[M100_SupplierRt.ColSPAdd03][3]			+":"	,10,1);
		JLabel LB_SPTel				= B100_FrameParts.JLabelSet(   0,300,130,20,RtSupplierRt[M100_SupplierRt.ColSPTel][3]				+":"	,10,1);
		JLabel LB_SPFax				= B100_FrameParts.JLabelSet(   0,325,130,20,RtSupplierRt[M100_SupplierRt.ColSPFax][3]				+":"	,10,1);
		JLabel LB_SPMail			= B100_FrameParts.JLabelSet(   0,350,130,20,RtSupplierRt[M100_SupplierRt.ColSPMail][3]			+":"	,10,1);
		JLabel LB_Com01				= B100_FrameParts.JLabelSet(   0,375,130,20,RtSupplierRt[M100_SupplierRt.ColCom01][3]				+":"	,10,1);
		JLabel LB_Com02				= B100_FrameParts.JLabelSet(   0,400,130,20,RtSupplierRt[M100_SupplierRt.ColCom02][3]				+":"	,10,1);
		JLabel LB_Com03				= B100_FrameParts.JLabelSet(   0,425,130,20,RtSupplierRt[M100_SupplierRt.ColCom03][3]				+":"	,10,1);
		JLabel LB_PTMSCDBMN			= B100_FrameParts.JLabelSet(   0,450,130,20,RtSupplierRt[M100_SupplierRt.ColPTMSCDBMN][3]		+":"	,10,1);
		JLabel LB_PTMSCDNINUSHI		= B100_FrameParts.JLabelSet(   0,475,130,20,RtSupplierRt[M100_SupplierRt.ColPTMSCDNINUSHI][3]	+":"	,10,1);
		JLabel LB_PaySite			= B100_FrameParts.JLabelSet(   0,500,130,20,RtSupplierRt[M100_SupplierRt.ColPaySite][3]			+":"	,10,1);
		JLabel LB_PayDate			= B100_FrameParts.JLabelSet(   0,525,130,20,RtSupplierRt[M100_SupplierRt.ColPayDate][3]			+":"	,10,1);
		JLabel LB_ShimeDate			= B100_FrameParts.JLabelSet(   0,550,130,20,RtSupplierRt[M100_SupplierRt.ColShimeDate][3]		+":"	,10,1);
		JLabel LB_EntryDate			= B100_FrameParts.JLabelSet(   0,575,130,20,RtSupplierRt[M100_SupplierRt.ColEntryDate][3]		+":"	,10,1);
		JLabel LB_UpdateDate		= B100_FrameParts.JLabelSet(   0,600,130,20,RtSupplierRt[M100_SupplierRt.ColUpdateDate][3]		+":"	,10,1);
		JLabel LB_EntryUser			= B100_FrameParts.JLabelSet( 330,575,130,20,RtSupplierRt[M100_SupplierRt.ColEntryUser][3]		+":"	,10,1);
		JLabel LB_UpdateUser		= B100_FrameParts.JLabelSet( 330,600,130,20,RtSupplierRt[M100_SupplierRt.ColUpdateUser][3]		+":"	,10,1);
		JLabel LB_DECD				= B100_FrameParts.JLabelSet(   0,625,130,20,RtSupplierRt[M100_SupplierRt.ColDECD][3]				+":"	,10,1);
		JLabel LB_DepartmentCd		= B100_FrameParts.JLabelSet(   0,650,130,20,RtSupplierRt[M100_SupplierRt.ColDepartmentCd][3]	+":"	,10,1);
		JLabel LB_DEName01			= B100_FrameParts.JLabelSet(   0,675,130,20,RtSupplierRt[M100_SupplierRt.ColDEName01][3]			+":"	,10,1);
		...
		final JTextField  TB_SPAdd03			= B100_FrameParts.JTextFieldSet( 			130,275,200,20,"",11,0);	//仕入先住所3
		final JTextField  TB_SPTel				= B100_FrameParts.JTextFieldSet( 			130,300,150,20,"",11,0);	//仕入先電話
		final JTextField  TB_SPFax				= B100_FrameParts.JTextFieldSet( 			130,325,150,20,"",11,0);	//仕入先FAX
		final JTextField  TB_SPMail				= B100_FrameParts.JTextFieldSet( 			130,350,200,20,"",11,0);	//仕入先MAIL
		final JTextField  TB_Com01				= B100_FrameParts.JTextFieldSet( 			130,375,200,20,"",11,0);	//コメント1
		final JTextField  TB_Com02				= B100_FrameParts.JTextFieldSet( 			130,400,200,20,"",11,0);	//コメント2
		final JTextField  TB_Com03				= B100_FrameParts.JTextFieldSet( 			130,425,200,20,"",11,0);	//コメント3
		final JTextField  TB_PTMSCDBMN			= B100_FrameParts.JTextFieldSet( 			130,450,100,20,"",11,0);	//基幹Sysコード（部門）
		final JTextField  TB_PTMSCDNINUSHI		= B100_FrameParts.JTextFieldSet( 			130,475,100,20,"",11,0);	//基幹Sysコード（荷主）
		final JFormattedTextField TB_PaySite	= B100_FrameParts.JFormattedTextFieldSet(130,500, 60,20,"1",11,1,"####");								//支払いサイト（月数）
		final JComboBox TB_PayDate				= B100_FrameParts.JComboBoxSet(			130,525, 60,20,B100_DefaultVariable.ShimeDateList[0],11);	//支払日（末日＝99）
		final JComboBox TB_ShimeDate			= B100_FrameParts.JComboBoxSet(			130,550, 60,20,B100_DefaultVariable.ShimeDateList[0],11);	//締め日（末日＝99）
		final JTextField  TB_EntryDate			= B100_FrameParts.JTextFieldSet( 			130,575,200,20,"",11,0);	//登録日
		final JTextField  TB_UpdateDate			= B100_FrameParts.JTextFieldSet( 			130,600,200,20,"",11,0);	//更新日
		final JTextField  TB_EntryUser			= B100_FrameParts.JTextFieldSet(			460,575,200,20,"",11,0);	//登録者
		final JTextField  TB_UpdateUser			= B100_FrameParts.JTextFieldSet(			460,600,200,20,"",11,0);	//更新者
		final JTextField  TB_DECD				= B100_FrameParts.JTextFieldSet( 			130,625,100,20,"",11,0);	//納品先コード
		final JTextField  TB_DepartmentCd		= B100_FrameParts.JTextFieldSet( 			130,650,100,20,"",11,0);	//部署CD
		final JTextField  TB_DEName01			= B100_FrameParts.JTextFieldSet( 			130,675,200,20,"",11,0);	//納品先名1
		...
		TB_PayDate.setSelectedIndex(	B100_DefaultVariable.ShimeDateList[0].length-1);
		TB_ShimeDate.setSelectedIndex(	B100_DefaultVariable.ShimeDateList[0].length-1);
		...
		if(!"".equals(TgSPCd)) {
			...
			if(1==SupplierRt.length) {
				...
				TB_SPAdd03.setText(			(String)SupplierRt[0][M100_SupplierRt.ColSPAdd03]);			//仕入先住所3
				TB_SPTel.setText(			(String)SupplierRt[0][M100_SupplierRt.ColSPTel]);				//仕入先電話
				TB_SPFax.setText(			(String)SupplierRt[0][M100_SupplierRt.ColSPFax]);				//仕入先FAX
				TB_SPMail.setText(			(String)SupplierRt[0][M100_SupplierRt.ColSPMail]);			//仕入先MAIL
				TB_Com01.setText(			(String)SupplierRt[0][M100_SupplierRt.ColCom01]);				//コメント1
				TB_Com02.setText(			(String)SupplierRt[0][M100_SupplierRt.ColCom02]);				//コメント2
				TB_Com03.setText(			(String)SupplierRt[0][M100_SupplierRt.ColCom03]);				//コメント3
				TB_PTMSCDBMN.setText(		(String)SupplierRt[0][M100_SupplierRt.ColPTMSCDBMN]);		//基幹Sysコード（部門）
				TB_PTMSCDNINUSHI.setText(	(String)SupplierRt[0][M100_SupplierRt.ColPTMSCDNINUSHI]);	//基幹Sysコード（荷主）
				TB_PaySite.setText(			""+(int)SupplierRt[0][M100_SupplierRt.ColPaySite]);			//支払いサイト（月数）
				
				for(int i=0;i<B100_DefaultVariable.ShimeDateList[1].length;i++) {
					if((""+(int)SupplierRt[0][M100_SupplierRt.ColPayDate]).equals(""+B100_DefaultVariable.ShimeDateList[1][i])) {
						TB_PayDate.setSelectedIndex(i);
					}
				}
				for(int i=0;i<B100_DefaultVariable.ShimeDateList[1].length;i++) {
					if((""+(int)SupplierRt[0][M100_SupplierRt.ColShimeDate]).equals(""+B100_DefaultVariable.ShimeDateList[1][i])) {
						TB_ShimeDate.setSelectedIndex(i);
					}
				}
				TB_EntryDate.setText(		(String)SupplierRt[0][M100_SupplierRt.ColEntryDate]);	//登録日
				TB_UpdateDate.setText(		(String)SupplierRt[0][M100_SupplierRt.ColUpdateDate]);	//更新日
				TB_EntryUser.setText(		(String)SupplierRt[0][M100_SupplierRt.ColEntryUser]);	//登録者
				TB_UpdateUser.setText(		(String)SupplierRt[0][M100_SupplierRt.ColUpdateUser]);	//更新者
				TB_DECD.setText(			(String)SupplierRt[0][M100_SupplierRt.ColDECD]);			//納品先コード
				TB_DepartmentCd.setText(	(String)SupplierRt[0][M100_SupplierRt.ColDepartmentCd]);	//部署CD
				TB_DEName01.setText(		(String)SupplierRt[0][M100_SupplierRt.ColDEName01]);		//納品先名1
			}
		}
		...
		final JTextField  TB_SearchDepartmentCd		= B100_FrameParts.JTextFieldSet(100, 50,100,20,"",11,0);			//届先部署CD
		final JTextField  TB_SearchDEName			= B100_FrameParts.JTextFieldSet(100, 75,100,20,"",11,0);			//届先名
		final JTextField  TB_SearchPost				= B100_FrameParts.JTextFieldSet(100,100,100,20,"",11,0);			//届先郵便
		final JTextField  TB_SearchAdd				= B100_FrameParts.JTextFieldSet(100,125,100,20,"",11,0);			//届先住所
		final JTextField  TB_SearchTel				= B100_FrameParts.JTextFieldSet(350, 25,100,20,"",11,0);			//届先TEL
		final JTextField  TB_SearchFax				= B100_FrameParts.JTextFieldSet(350, 50,100,20,"",11,0);			//届先FAX
		...
		SearchBtn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					GetSearchTel			= B100_TextControl.Trim(GetSearchTel);
					GetSearchFax			= B100_TextControl.Trim(GetSearchFax);
					GetSearchMail			= B100_TextControl.Trim(GetSearchMail);
				...
				if(RenewFg) {
					...
					for(int i=0;i<RowCount;i++) {
						if((boolean)MainFmTableModel.getValueAt(i, 0)) {
							TB_DECD.setText(""+MainFmTableModel.getValueAt(i, M100_DeliveryMstRt.ColDECD+1));
							TB_DepartmentCd.setText(""+MainFmTableModel.getValueAt(i, M100_DeliveryMstRt.ColDepartmentCd+1));
							TB_DEName01.setText(""+MainFmTableModel.getValueAt(i, M100_DeliveryMstRt.ColDEName01+1));
						}
					}
		...
		entry_btn.addActionListener(new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					String GetPayDate		= B100_DefaultVariable.ShimeDateList[1][TB_PayDate.getSelectedIndex()];		//支払日（末日＝99）
					String GetShimeDate		= B100_DefaultVariable.ShimeDateList[1][TB_ShimeDate.getSelectedIndex()];	//締め日（末日＝99）
				...
				if(RenewFg) {
					...
					if(0<PostRt.length) {
						...
						if(KickFg) {
							...
							TB_SPAdd01.setText(""+PostRt[0][M100_PostMstRt.ColPREFECTURES]+PostRt[0][M100_PostMstRt.ColMUNICI01]);
							TB_SPAdd02.setText(""+PostRt[0][M100_PostMstRt.ColMUNICI02]);
						}
					}
					RenewFg = true;
				}
	...
	private static String[] TxtTrim(
		...
		GetWhCd				= B100_TextControl.Trim(GetWhCd);
		GetSPCd				= B100_TextControl.Trim(GetSPCd);
		GetSPName01			= B100_TextControl.Trim(GetSPName01);
		GetSPName02			= B100_TextControl.Trim(GetSPName02);
		GetSPName03			= B100_TextControl.Trim(GetSPName03);
		GetSPPost			= B100_TextControl.Trim(GetSPPost);
		GetSPAdd01			= B100_TextControl.Trim(GetSPAdd01);
		GetSPAdd02			= B100_TextControl.Trim(GetSPAdd02);
		GetSPAdd03			= B100_TextControl.Trim(GetSPAdd03);
		GetSPTel			= B100_TextControl.Trim(GetSPTel);
		GetSPFax			= B100_TextControl.Trim(GetSPFax);
		GetSPMail			= B100_TextControl.Trim(GetSPMail);
		GetCom01			= B100_TextControl.Trim(GetCom01);
		GetCom02			= B100_TextControl.Trim(GetCom02);
		GetCom03			= B100_TextControl.Trim(GetCom03);
		GetPTMSCDBMN		= B100_TextControl.Trim(GetPTMSCDBMN);
		GetPTMSCDNINUSHI	= B100_TextControl.Trim(GetPTMSCDNINUSHI);
		GetPaySite			= B100_TextControl.Trim(GetPaySite);
		GetPayDate			= B100_TextControl.Trim(GetPayDate);
		GetShimeDate		= B100_TextControl.Trim(GetShimeDate);
		GetDECD				= B100_TextControl.Trim(GetDECD);
		GetDepartmentCd		= B100_TextControl.Trim(GetDepartmentCd);
		
		GetPaySite			= B100_TextControl.num_only_String02(GetPaySite);
		GetPayDate			= B100_TextControl.num_only_String02(GetPayDate);
		GetShimeDate		= B100_TextControl.num_only_String02(GetShimeDate);
		
		GetSPPost			= B100_TextControl.num_only_String(GetSPPost);
		GetSPTel			= B100_TextControl.num_only_String(GetSPTel);
		GetSPFax			= B100_TextControl.num_only_String(GetSPFax);
	...
	private static void DataEntry(
		...
		if("".equals(GetSPCd)) {GetSPCd = M100_SupplierRt.NewSpCdGet(1)[0];}
		...
		B100_DefaultVariable.SupplierList();
	}
	...
	private static void ErrView(ArrayList<String>ErrMsg) {
		...
		FLD_PATH = A00000_Main.MainFLD+"\\MstControl\\SupplierMst";
		B100_FolderCheck.FLD_CHECK(FLD_PATH);
		FLD_PATH = A00000_Main.MainFLD+"\\MstControl\\SupplierMst\\Err";
		B100_FolderCheck.FLD_CHECK(FLD_PATH);
		FLD_PATH = A00000_Main.MainFLD+"\\MstControl\\SupplierMst\\BK";
		B100_FolderCheck.FLD_CHECK(FLD_PATH);
