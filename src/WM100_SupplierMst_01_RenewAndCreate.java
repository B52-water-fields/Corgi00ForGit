				...
				if(RenewFg) {
					...
					for(int i=0;i<RowCount;i++) {
						if((boolean)tableModel_ms01.getValueAt(i, 0)) {
							TB_DECD.setText(""+tableModel_ms01.getValueAt(i, M100_DeliveryMstRt.ColDECD+1));
							TB_DepartmentCd.setText(""+tableModel_ms01.getValueAt(i, M100_DeliveryMstRt.ColDepartmentCd+1));
							TB_DEName01.setText(""+tableModel_ms01.getValueAt(i, M100_DeliveryMstRt.ColDEName01+1));
						}
					}
