...
public class WM100ItemRecomendLocMstSearch{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(KickFg) {
						...
						WM100ItemRecomendLocMstRenewAndCreate.ItemRecomendLocMstRenewAndCreate(0,0,TgtClCd,TgtWhCd,TgtItemCd);
					}
					RenewFg = true;
				}
			}
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100ItemRecomendLocMstExcelEntry.ItemRecomendLocMstExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
