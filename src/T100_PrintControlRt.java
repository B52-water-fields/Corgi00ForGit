...
public class T100_PrintControlRt{
	//印刷済み管理
	/*
	コピペ用
	...
	String GetPrintCd		= (String)PrintControlRt[i][T100_PrintControlRt.ColPrintCd];		//印刷帳票CD
	String GetOkuriNo		= (String)PrintControlRt[i][T100_PrintControlRt.ColOkuriNo];		//送り状番号等
	String GetKey01			= (String)PrintControlRt[i][T100_PrintControlRt.ColKey01];			//サブキー01
	String GetKey02			= (String)PrintControlRt[i][T100_PrintControlRt.ColKey02];			//サブキー02
	String GetKey03			= (String)PrintControlRt[i][T100_PrintControlRt.ColKey03];			//サブキー03
	String GetKey04			= (String)PrintControlRt[i][T100_PrintControlRt.ColKey04];			//サブキー04
	String GetEntryDate		= (String)PrintControlRt[i][T100_PrintControlRt.ColEntryDate];		//登録日
	String GetUpdateDate	= (String)PrintControlRt[i][T100_PrintControlRt.ColUpdateDate];	//更新日
	String GetEntryUser		= (String)PrintControlRt[i][T100_PrintControlRt.ColEntryUser];		//登録者
	String GetUpdateUser	= (String)PrintControlRt[i][T100_PrintControlRt.ColUpdateUser];	//更新者
	...
	*/
	...
	public static Object[][] PrintControlRt(
		...
		String sql = "select "
					...
					+ " from "+A00000_Main.MySqlDefaultSchemaNYANKO+".KT0040_PrintControl\n"
					+ " where 1=1\n"
					;
