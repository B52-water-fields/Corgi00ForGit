...
public class WM100UserMstSearch{
	static int SetX;
	static int SetY;
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					for(int i=0;i<UserMstRt.length;i++) {
						...
						SetOb[ 0] = false;	//FG
						SetOb[ 1] = ""+UserMstRt[i][M100UserMstRt.ColWHCD];						//倉庫CD
						SetOb[ 2] = ""+UserMstRt[i][M100UserMstRt.ColShippingCompanyCd];		//運送会社CD
						SetOb[ 3] = ""+UserMstRt[i][M100UserMstRt.ColUserCd];					//ユーザーCD
						SetOb[ 4] = ""+UserMstRt[i][M100UserMstRt.ColWHName];					//倉庫名
						SetOb[ 5] = ""+UserMstRt[i][M100UserMstRt.ColShippingCompanyName01];	//運送会社名
						SetOb[ 6] = ""+UserMstRt[i][M100UserMstRt.ColUserName01];				//ユーザー名1
						SetOb[ 7] = ""+UserMstRt[i][M100UserMstRt.ColUserName02];				//ユーザー名2
						SetOb[ 8] = ""+UserMstRt[i][M100UserMstRt.ColUserName03];				//ユーザー名3
						SetOb[ 9] = (int)UserMstRt[i][M100UserMstRt.ColAuthorityFG];			//権限区分
						SetOb[10] = ""+UserMstRt[i][M100UserMstRt.ColCarCd];						//標準車輛CD
						SetOb[11] = ""+UserMstRt[i][M100UserMstRt.ColCarName01];				//車両名称01
						SetOb[12] = ""+UserMstRt[i][M100UserMstRt.ColCarName02];				//車両名称02
						SetOb[13] = ""+UserMstRt[i][M100UserMstRt.ColCarName03];				//車両名称03
						SetOb[14] = ""+UserMstRt[i][M100UserMstRt.ColPost];						//郵便番号
						SetOb[15] = ""+UserMstRt[i][M100UserMstRt.ColAdd01];						//住所1
						SetOb[16] = ""+UserMstRt[i][M100UserMstRt.ColAdd02];						//住所2
						SetOb[17] = ""+UserMstRt[i][M100UserMstRt.ColAdd03];						//住所3
						SetOb[18] = ""+UserMstRt[i][M100UserMstRt.ColTel];						//電話番号
						SetOb[19] = ""+UserMstRt[i][M100UserMstRt.ColFax];						///FAX
						SetOb[20] = ""+UserMstRt[i][M100UserMstRt.ColMail];						//メールアドレス
						SetOb[21] = ""+UserMstRt[i][M100UserMstRt.ColCom01];						//コメント1
						SetOb[22] = ""+UserMstRt[i][M100UserMstRt.ColCom02];						//コメント2
						SetOb[23] = ""+UserMstRt[i][M100UserMstRt.ColCom03];						//コメント3
						SetOb[24] = ""+UserMstRt[i][M100UserMstRt.ColEntryUser];				//登録者コード
						SetOb[25] = ""+UserMstRt[i][M100UserMstRt.ColUpdateUser];				//更新者コード
						SetOb[26] = ""+UserMstRt[i][M100UserMstRt.ColEntryDate];				//データ登録日時
						SetOb[27] = ""+UserMstRt[i][M100UserMstRt.ColUpdateDate];				//データ更新日時
						SetOb[28] = ""+UserMstRt[i][M100UserMstRt.ColPTMSCD];					//基幹システムユーザーコード
						SetOb[29] = (int)UserMstRt[i][M100UserMstRt.ColDelFg];					//削除区分
						SetOb[30] = ""+UserMstRt[i][M100UserMstRt.ColMainClient];				//主要担当荷主CD
						SetOb[31] = ""+UserMstRt[i][M100UserMstRt.ColCLName01];					//主要担当荷主名
						SetOb[32] = ""+UserMstRt[i][M100UserMstRt.ColPassWord];					//パスワード
						
						//パスワードは一覧に出さない
						if("".equals(""+UserMstRt[i][M100UserMstRt.ColPassWord])) {
						}else {
							SetOb[32] = "********";
						}
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(!"".equals(TgtUser)) {
						...
						main_fm.dispose();
						WM100UserMstRenewAndCreate.UserMstRenewAndCreate(0,0,TgtWhCd,TgtShippingCompanyCd,TgtUser);
					}
					RenewFg = true;
				}
			}
			...
			public void actionPerformed(ActionEvent e){
				if(RenewFg) {
					...
					if(null!=Selected && !Selected.equals(Selected.replace(".xlsx", ""))) {
						...
						main_fm.setVisible(false);
						main_fm.dispose();
						WM100UserMstExcelEntry.UserMstExcelEntry(0,0,Selected);
					}
					RenewFg = true;
				}
			}
